              ...
              <ul class="list-group list-group-flush">
                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <img src={{asset("assets/img/1.png")}} alt class="w-px-40 h-auto rounded-circle" />
                      </div>
                    </div>
                ...
                <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <img src={{asset("assets/img/2.png")}} alt class="w-px-40 h-auto rounded-circle" />
                      </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <img src={{asset("assets/img/5.png")}} alt class="w-px-40 h-auto rounded-circle" />
                      </div>
                    </div>
                    <div class="flex-grow-1">
                ...
                <li class="list-group-item list-group-item-action dropdown-notifications-item">
                  <div class="d-flex">
                    <div class="flex-shrink-0 me-3">
                      <div class="avatar">
                        <img src={{asset("assets/img/6.png")}} alt class="w-px-40 h-auto rounded-circle" />
                      </div>
                    </div>
                    <div class="flex-grow-1">
            ...
            <li>
              <div class="d-grid px-4 pt-2 pb-1">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <a class="btn btn-danger d-flex" onclick="event.preventDefault();this.closest('form').submit();" :href="route('logout')" target="_blank">
