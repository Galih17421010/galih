...
<footer class="landing-footer">
    <div class="footer-top position-relative overflow-hidden">
      <img src={{asset("build/assets/img/footer-bg.png")}} alt="footer bg" class="footer-bg banner-bg-img" />
      <div class="container position-relative">
        <div class="row gx-0 gy-7 gx-sm-6 gx-lg-12">
          <div class="col-lg-5">
            <a href="home.html" class="app-brand-link mb-6">
          ...
          <div class="col-lg-3 col-md-4">
            ...
            <a href="javascript:void(0);" class="d-block footer-link mb-4">
                <img src={{asset("build/assets/img/apple-icon.png")}} alt="apple icon" />
            </a>
            <a href="javascript:void(0);" class="d-block footer-link">
                <img src={{asset("build/assets/img/google-play-icon.png")}} alt="google play icon" />
            </a>
          </div>
        </div>
      </div>
