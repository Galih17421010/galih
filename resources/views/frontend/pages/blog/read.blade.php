    ...
    <div class="container">
      <div class="row gy-4 gy-lg-0">
        <div class="col-lg-8">
          ...
          <div class="my-6">
            <img src={{asset("assets/img/product-image.png")}} alt="product" class="img-fluid w-100">
          </div>
          ...
          <div class="mt-6">
            <img src={{asset("assets/img/checkout-image.png")}} alt="product" class="img-fluid w-100">
          </div>
        </div>
        <div class="col-lg-4">
