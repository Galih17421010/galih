...
<section id="landingCTA" class="section-py landing-cta p-lg-0 pb-0 position-relative">
    <img src={{asset("build/assets/img/cta-bg.png")}} class="position-absolute bottom-0 end-0 scaleX-n1-rtl h-100 w-100 z-n1" alt="cta image" />
    <div class="container">
      <div class="row align-items-center gy-5 gy-lg-0">
        ...
        <div class="col-lg-6 pt-lg-12">
          <img src={{asset("build/assets/img/cta-dashboard.png")}} alt="cta dashboard" class="img-fluid" />
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-lg-5">
          <div class="card h-100">
            <div class="bg-primary rounded text-white card-body p-lg-8">
              ...
              <img src={{asset("build/assets/img/let’s-contact.png")}} alt="let’s contact" class="w-100 mb-4 pb-1" />
