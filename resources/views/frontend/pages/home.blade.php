<!-- Hero: Start -->
<section id="home" class="section-py landing-hero position-relative">
    ...
    <div class="container">
      <div class="hero-text-box text-center">
        ...
        <a href="#" class="btn btn-lg btn-primary">Get early access</a>
      </div>
      <div class="position-relative hero-animation-img">
        <a href="../vertical-menu-template/dashboards-crm.html" target="_blank">
          <div class="hero-dashboard-img text-center">
            {{-- <img src={{asset("assets/img/hero-dashboard-light.png")}} alt="hero dashboard" class="animation-img" data-speed="2" data-app-light-img="hero-dashboard-light.png" data-app-dark-img="hero-dashboard-dark.png" /> --}}
          </div>
          <div class="position-absolute hero-elements-img">
            {{-- <img src={{asset("assets/img/hero-elements-light.png")}} alt="hero elements" class="animation-img" data-speed="4" data-app-light-img="hero-elements-light.png" data-app-dark-img="hero-elements-dark.png" /> --}}
          </div>
        </a>
      </div>
    </div>
