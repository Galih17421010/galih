      ...
      <div class="features-icon-wrapper row gx-0 gy-12 gx-sm-6">
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-4">
            <img src={{asset("build/assets/img/laptop-charging.png")}} alt="laptop charging" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-4">
            <img src={{asset("build/assets/img/transition-up.png")}} alt="transition up" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-4">
            <img src={{asset("build/assets/img/edit.png")}} alt="edit" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-4">
            <img src={{asset("build/assets/img/3d-select-solid.png")}} alt="3d select solid" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-4">
            <img src={{asset("build/assets/img/lifebelt.png")}} alt="lifebelt" />
          </div>
        ...
        <div class="col-lg-4 col-sm-6 text-center features-icon-box">
          <div class="features-icon mb-4">
            <img src={{asset("build/assets/img/google-docs.png")}} alt="google docs" />
          </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="card h-100">
                  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                    <div class="mb-4">
                      <img src={{asset("build/assets/img/logo-4.png")}} alt="client logo" class="client-logo img-fluid" />
                    </div>
              ...
              <div class="swiper-slide">
                <div class="card h-100">
                  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                    <div class="mb-4">
                      <img src={{asset("build/assets/img/logo-1.png")}} alt="client logo" class="client-logo img-fluid" />
                    </div>
              ...
              <div class="swiper-slide">
                <div class="card h-100">
                  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                    <div class="mb-4">
                      <img src={{asset("build/assets/img/logo-3.png")}} alt="client logo" class="client-logo img-fluid" />
                    </div>
              ...
              <div class="swiper-slide">
                <div class="card h-100">
                  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                    <div class="mb-4">
                      <img src={{asset("build/assets/img/logo-2.png")}} alt="client logo" class="client-logo img-fluid" />
                    </div>
              ...
              <div class="swiper-slide">
                <div class="card h-100">
                  <div class="card-body text-body d-flex flex-column justify-content-between text-center p-lg-8">
                    <div class="mb-4">
                      <img src={{asset("build/assets/img/logo-5.png")}} alt="client logo" class="client-logo img-fluid" />
                    </div>
                    <p class="text-heading">“I've never used a theme as versatile and flexible as Vuexy. It's my go to for building dashboard sites on almost any project.”</p>
                    <div class="text-warning mb-4">
                      <i class="tf-icons ri-star-fill ri-24px"></i>
        ...
        <div class="container">
          <div class="swiper-logo-carousel pt-lg-4 mt-12">
            <div class="swiper" id="swiper-clients-logos">
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  <img src={{asset("build/assets/img/logo-1-light.png")}} alt="client logo" class="client-logo" data-app-light-img="logo-1-light.png" data-app-dark-img="logo-1-dark.png" />
                </div>
                <div class="swiper-slide">
                  <img src={{asset("build/assets/img/logo-2-light.png")}} alt="client logo" class="client-logo" data-app-light-img="logo-2-light.png" data-app-dark-img="logo-2-dark.png" />
                </div>
                <div class="swiper-slide">
                  <img src={{asset("build/assets/img/logo-3-light.png")}} alt="client logo" class="client-logo" data-app-light-img="logo-3-light.png" data-app-dark-img="logo-3-dark.png" />
                </div>
                <div class="swiper-slide">
                  <img src={{asset("build/assets/img/logo-4-light.png")}} alt="client logo" class="client-logo" data-app-light-img="logo-4-light.png" data-app-dark-img="logo-4-dark.png" />
                </div>
                <div class="swiper-slide">
                  <img src={{asset("build/assets/img/logo-5-light.png")}} alt="client logo" class="client-logo" data-app-light-img="logo-5-light.png" data-app-dark-img="logo-5-dark.png" />
                </div>
              </div>
            </div>
          </div>
