...
`;
    ...
    typeof Object.assign != "function"
      ? (g = function (e) {
          ...
          for (var i = Object(e), r = 1; r < arguments.length; r++) {
            var n = arguments[r];
            if (n !== l && n !== null) for (var s in n) n.hasOwnProperty(s) && (i[s] = n[s]);
          }
          return i;
        })
      : (g = Object.assign);
    var Ot = Nt(
        function (e, i, r) {
          for (var n = Object.keys(i), s = 0; s < n.length; ) (!r || (r && e[n[s]] === l)) && (e[n[s]] = i[n[s]]), s++;
          return e;
        },
        "extend",
        "Use `assign`."
    ...
    function he(t) {
      ...
      return i ? (e = i) : re ? (e = ft) : ne ? (e = tt) : Mt ? (e = vt) : (e = $), new e(t, le);
    }
    function le(t, e, i) {
      var r = i.pointers.length,
        ...
        s = e & f && r - n === 0,
        a = e & (o | p) && r - n === 0;
      (i.isFirst = !!s), (i.isFinal = !!a), s && (t.session = {}), (i.eventType = e), ce(t, i), t.emit("hammer.input", i), t.recognize(i), (t.session.prevInput = i);
    }
    function ce(t, e) {
      var i = t.session,
        r = e.pointers,
      ...
      var s = i.firstInput,
        ...
        c = (e.center = xt(r));
      (e.timeStamp = at()), (e.deltaTime = e.timeStamp - s.timeStamp), (e.angle = ut(h, c)), (e.distance = K(h, c)), ue(i, e), (e.offsetDirection = Ht(e.deltaX, e.deltaY));
    ...
    function ue(t, e) {
      var i = e.center,
        ...
        n = t.prevDelta || {},
        s = t.prevInput || {};
      (e.eventType === f || s.eventType === o) && ((n = t.prevDelta = { x: s.deltaX || 0, y: s.deltaY || 0 }), (r = t.offsetDelta = { x: i.x, y: i.y })), (e.deltaX = n.x + (i.x - r.x)), (e.deltaY = n.y + (i.y - r.y));
    }
    function fe(t, e) {
      ...
      } else (n = i.velocity), (s = i.velocityX), (a = i.velocityY), (h = i.direction);
    ...
    function Lt(t) {
      ...
      return { timeStamp: at(), pointers: e, center: xt(e), deltaX: t.deltaX, deltaY: t.deltaY };
    }
    function xt(t) {
      var e = t.length;
    ...
    function $() {
      (this.evEl = de), (this.evWin = me), (this.pressed = !1), d.apply(this, arguments);
    }
    T($, d, {
      handler: function (e) {
        var i = Te[e.type];
        i & f && e.button === 0 && (this.pressed = !0),
          i & M && e.which !== 1 && (i = o),
          this.pressed && (i & o && (this.pressed = !1), this.callback(this.manager, i, { pointers: [e], changedPointers: [e], pointerType: ct, srcEvent: e }));
      },
    });
    var Ee = { pointerdown: f, pointermove: M, pointerup: o, pointercancel: p, pointerout: p },
    ...
    T(ft, d, {
      handler: function (e) {
        ...
        s & f && (e.button === 0 || h) ? c < 0 && (i.push(e), (c = i.length - 1)) : s & (o | p) && (r = !0),
          !(c < 0) && ((i[c] = e), this.callback(this.manager, s, { pointers: i, changedPointers: [e], pointerType: a, srcEvent: e }), r && i.splice(c, 1));
      },
    });
    ...
    function Ft() {
      (this.evTarget = _e), (this.evWin = ye), (this.started = !1), d.apply(this, arguments);
    }
    T(Ft, d, {
      handler: function (e) {
        var i = Ie[e.type];
        if ((i === f && (this.started = !0), !!this.started)) {
          ...
          i & (o | p) && r[0].length - r[1].length === 0 && (this.started = !1), this.callback(this.manager, i, { pointers: r[0], changedPointers: r[1], pointerType: b, srcEvent: e });
        }
      },
    });
    function Pe(t, e) {
    ...
    T(tt, d, {
      handler: function (e) {
        var i = Ne[e.type],
          r = Ae.call(this, e, i);
        r && this.callback(this.manager, i, { pointers: r[0], changedPointers: r[1], pointerType: b, srcEvent: e });
      },
    });
    function Ae(t, e) {
      var i = B(t.touches),
      ...
      for (n = 0; n < a.length; ) r[a[n].identifier] && h.push(a[n]), e & (o | p) && delete r[a[n].identifier], n++;
    ...
    Tt.prototype = {
      ...
      preventDefaults: function (t) {
        ...
        if (!(a && s) && (n || (s && i & I) || (a && i & U))) return this.preventSrc(e);
      },
    ...
    var it = 1,
      ...
      _ = 32;
    function O(t) {
      (this.options = g({}, this.defaults, t || {})), (this.id = ee()), (this.manager = null), (this.options.enable = At(this.options.enable, !0)), (this.state = it), (this.simultaneous = {}), (this.requireFail = []);
    }
    O.prototype = {
      defaults: {},
      set: function (t) {
      ...
      dropRecognizeWith: function (t) {
        return x(t, "dropRecognizeWith", this) ? this : ((t = rt(t, this)), delete this.simultaneous[t.id], this);
      },
      ...
      recognize: function (t) {
        ...
        this.state & (N | G | _) && (this.state = it), (this.state = this.process(e)), this.state & (m | H | C | G) && this.tryEmit(e);
      },
      process: function (t) {},
    ...
    function zt(t) {
      return t & G ? "cancel" : t & C ? "end" : t & H ? "move" : t & m ? "start" : "";
    }
    function Zt(t) {
    ...
    T(E, O, {
      ...
      process: function (t) {
        var e = this.state,
          ...
          r = e & (m | H),
          n = this.attrTest(t);
        return r && (i & p || !n) ? e | G : r || n ? (i & o ? e | C : e & m ? e | H : m) : _;
      },
    });
    function nt() {
    ...
    T(nt, E, {
      ...
      directionTest: function (t) {
        var e = this.options,
          ...
          a = t.deltaY;
        return (
          n & e.direction || (e.direction & I ? ((n = s === 0 ? Q : s < 0 ? X : F), (i = s != this.pX), (r = Math.abs(t.deltaX))) : ((n = a === 0 ? Q : a < 0 ? V : W), (i = a != this.pY), (r = Math.abs(t.deltaY)))),
          (t.direction = n),
          i && r > e.threshold && n & e.direction
        );
      },
      attrTest: function (t) {
        return E.prototype.attrTest.call(this, t) && (this.state & m || (!(this.state & m) && this.directionTest(t)));
      },
      emit: function (t) {
    ...
    T(mt, O, {
      ...
      process: function (t) {
        ...
        if (((this._input = t), !r || !i || (t.eventType & (o | p) && !n))) this.reset();
    ...
    T(gt, E, {
      defaults: { event: "swipe", threshold: 10, velocity: 0.3, direction: I | U, pointers: 1 },
      getTouchAction: function () {
      ...
      attrTest: function (t) {
        var e = this.options.direction,
          i;
        return (
          e & (I | U) ? (i = t.overallVelocity) : e & I ? (i = t.overallVelocityX) : e & U && (i = t.overallVelocityY),
          this._super.attrTest.call(this, t) && e & t.offsetDirection && t.distance > this.options.threshold && t.maxPointers == this.options.pointers && S(i) > this.options.velocity && t.eventType & o
        );
      },
      emit: function (t) {
    ...
    T(st, O, {
      ...
      process: function (t) {
        var e = this.options,
          ...
          r = t.distance < e.threshold,
          n = t.deltaTime < e.time;
        if ((this.reset(), t.eventType & f && this.count === 0)) return this.failTimeout();
        if (r && n && i) {
    ...
    function A(t, e) {
      return (e = e || {}), (e.recognizers = At(e.recognizers, A.defaults.preset)), new It(t, e);
    }
    (A.VERSION = "2.0.7"),
      (A.defaults = {
        domEvents: !1,
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[Et, { enable: !1 }], [dt, { enable: !1 }, ["rotate"]], [gt, { direction: I }], [nt, { direction: I }, ["swipe"]], [st], [st, { event: "doubletap", taps: 2 }, ["tap"]], [mt]],
    ...
    It.prototype = {
      ...
      recognize: function (t) {
        ...
        if (!e.stopped) {
          ...
          for (var s = 0; s < r.length; ) (i = r[s]), e.stopped !== Bt && (!n || i == n || i.canRecognizeWith(n)) ? i.recognize(t) : i.reset(), !n && i.state & (m | H | C) && (n = e.curRecognizer = i), s++;
        }
      },
      get: function (t) {
