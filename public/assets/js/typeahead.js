            ...
            (r = function (t) {
              return (s.Bloodhound =
                ...
                (l = (function () {
                  "use strict";
                  function t(t) {
                    (this.url = t.url), (this.prepare = t.prepare), (this.transform = t.transform), (this.transport = new a({ cache: t.cache, limiter: t.limiter, transport: t.transport }));
                  }
                  return (
                    n.mixin(t.prototype, {
                      _settings: function () {
                ...
                (f = (function () {
                  ...
                  return function (r) {
                    var s, o;
                    return (
                      (s = { initialize: !0, identify: n.stringify, datumTokenizer: null, queryTokenizer: null, sufficient: 5, sorter: null, local: [], prefetch: null, remote: null }),
                      ...
                      (r.prefetch = (function (r) {
                        var s;
                        return r
                          ? ((s = { url: null, ttl: 864e5, cache: !0, cacheKey: null, thumbprint: "", prepare: n.identity, transform: n.identity, transport: null }),
                ...
                (d = (function () {
                  ...
                  function i(t) {
                    (t = f(t)),
                      ...
                      (this.index = new c({ identify: this.identify, datumTokenizer: t.datumTokenizer, queryTokenizer: t.queryTokenizer })),
                ...
                (s = (function () {
                  ...
                  return {
                    ...
                    trigger: function (n) {
                      var r, s, o, u, a;
                      if (!this._callbacks) return this;
                      for (n = n.split(t), o = [].slice.call(arguments, 1); (r = n.shift()) && (s = this._callbacks[r]); ) (u = i(s.sync, this, [r].concat(o))), (a = i(s.async, this, [r].concat(o))), u() && e(a);
                      return this;
                    },
                  };
                  function n(e, n, i, r) {
                  ...
                  return function (i) {
                    ...
                    (i = n.mixin({}, e, i)).node &&
                      ...
                      (function t(e, n) {
                        ...
                        return (
                          (n = r.exec(e.data)) &&
                            ((o = t.createElement(i.tagName)), i.className && (o.className = i.className), (s = e.splitText(n.index)).splitText(n[0].length), o.appendChild(s.cloneNode(!0)), e.parentNode.replaceChild(o, s)),
                          !!n
                        );
                      }));
                  };
                  ...
                  return (
                    n.mixin(t.prototype, {
                      ...
                      _updateHint: function () {
                        ...
                        (t = this.menu.getTopSelectable()),
                          ...
                          !e || n.isBlankString(i) || this.input.hasOverflow()
                            ...
                            : ((r = u.normalizeQuery(i)), (s = n.escapeRegExChars(r)), (o = new RegExp("^(?:" + s + ")(.+$)", "i").exec(e.val)) && this.input.setHint(i + o[1]));
                      },
                      isEnabled: function () {
                        return this.enabled;
                      },
                      ...
                      autocomplete: function (t) {
                        var e, n;
                        return (
                          (e = this.input.getQuery()), !(!(n = this.menu.getSelectableData(t)) || e === n.val || this.eventBus.before("autocomplete", n.obj) || (this.input.setQuery(n.val), this.eventBus.trigger("autocomplete", n.obj), 0))
                        );
                      },
                        ...
                        return (
                          ...
                          this.each(function () {
                            ...
                            n.each(o, function (e) {
                              ...
                              p && p.val(""),
                              (i = (function (t, e) {
                                t.data(s.attrs, { dir: t.attr("dir"), autocomplete: t.attr("autocomplete"), spellcheck: t.attr("spellcheck"), style: t.attr("style") }),
                              ...
                              (w = new l({ input: _, menu: b, eventBus: v, minLength: t.minLength }, a)),
                              i.data(s.www, a),
