!(function (t, e) {
  ...
  return (function () {
    ...
    function R(t, e) {
      ...
      t.events = { tap: r || o, drag: n, dragAll: l, smoothSteps: u, fixed: i, snap: o, hover: s, unconstrained: a };
    }
    function T(t, e) {
      if (!1 !== e)
        if (!0 === e || i(e)) {
    ...
    function $(t) {
      var e = { margin: null, limit: null, padding: null, animate: !0, animationDuration: 300, ariaFormat: x, format: x },
        ...
        n = { connect: !1, direction: "ltr", behaviour: "tap", orientation: "horizontal", keyboardSupport: !0, cssPrefix: "noUi-", cssClasses: y, keyboardPageMultiplier: 5, keyboardMultiplier: 1, keyboardDefaultStep: 10 };
    ...
    function G(r, n, i) {
              ...
              return (function (t, e) {
                ...
                if ((t.preventDefault(), f || p)) {
                  var h = p ? 0 : 1,
                    m = ht(e)[h];
                  if (null === m) return !1;
                  !1 === m && (m = P.getDefaultStep(A[e], p, n.keyboardDefaultStep)), (m *= c || u ? n.keyboardPageMultiplier : n.keyboardMultiplier), (m = Math.max(m, 1e-7)), (m *= p ? -1 : 1), (a = V[e] + m);
                } else a = d ? n.spectrum.xVal[n.spectrum.xVal.length - 1] : n.spectrum.xVal[0];
                return ut(e, P.toStepping(a), !0, !0), nt("slide", e), nt("update", e), nt("change", e), nt("set", e), !1;
              })(t, e);
            })),
            ...
            return (
              ...
              i.forEach(function (n, s) {
                var a,
                  ...
                  y = i[s + 1],
                  w = r.mode === t.Steps;
                for (w && (a = P.xNumSteps[s]), a || (a = y - x), void 0 === y && (y = x), a = Math.max(a, 1e-7), p = x; p <= y; p = Number((p + a).toFixed(7))) {
                  for (v = (h = (d = P.toStepping(p)) - c) / (r.density || 1), S = h / (b = Math.round(v)), f = 1; f <= b; f += 1) o[(m = c + f * S).toFixed(5)] = [P.fromStepping(m), 0];
                  (g = i.indexOf(p) > -1 ? e.LargeValue : w ? e.SmallValue : e.NoValue), !s && l && p !== y && (g = 0), (p === y && u) || (o[d.toFixed(5)] = [p, g]), (c = d);
                }
              }),
              o
            );
                ...
                !(function (t, o, s) {
                  if ((s = r ? r(o, s) : s) !== e.None) {
                    ...
                    (l.className = f(s, n.cssClasses.marker)),
                      (l.style[n.style] = t + "%"),
                      s > e.NoValue && (((l = z(a, !1)).className = f(s, n.cssClasses.value)), l.setAttribute("data-value", String(o)), (l.style[n.style] = t + "%"), (l.innerHTML = String(i.to(o))));
                  }
                })(o, t[o][0], t[o][1]);
              }),
              a
        ...
        var o = function (o) {
            var s,
              ...
              l = (function (t, e, r) {
                ...
                return (e = e || m(D)), (i || o) && ((s = t.clientX + e.x), (a = t.clientY + e.y)), (t.pageOffset = e), (t.points = [s, a]), (t.cursor = i || o), t;
            ...
            return (
              ...
              !((s.classList ? s.classList.contains(a) : new RegExp("\\b" + a + "\\b").test(s.className)) && !i.doNotReject) &&
                ...
                (!i.hover || !l.buttons) &&
                (C || l.preventDefault(), (l.calcPoint = l.points[n.ort]), void r(l, i)))
            );
          },
          s = [];
        return (
      ...
      function Z(t, e) {
        e.handle && (h(e.handle, n.cssClasses.active), (U -= 1)),
          ...
          0 === U && (h(N, n.cssClasses.drag), lt(), t.cursor && ((L.style.cursor = ""), L.removeEventListener("selectstart", a))),
      ...
      function tt(t, e) {
        if (!e.handleNumbers.some(_)) {
          var r;
          1 === e.handleNumbers.length && ((r = f[e.handleNumbers[0]].children[0]), (U += 1), d(r, n.cssClasses.active)), t.stopPropagation();
          var i = [],
            o = G(y.move, O, Q, {
              target: t.target,
              handle: r,
            ...
            s = G(y.end, O, Z, { target: t.target, handle: r, listeners: i, doNotReject: !0, handleNumbers: e.handleNumbers }),
            l = G("mouseout", O, K, { target: t.target, handle: r, listeners: i, doNotReject: !0, handleNumbers: e.handleNumbers });
          i.push.apply(i, o.concat(s, l)),
            t.cursor && ((L.style.cursor = getComputedStyle(t.target).cursor), f.length > 1 && d(N, n.cssClasses.drag), L.addEventListener("selectstart", a, !1)),
            e.handleNumbers.forEach(function (t) {
              nt("start", t);
            });
        }
      ...
      function it(t, e, r, i, o, s, a) {
        ...
        return (
          f.length > 1 &&
            ...
            (i && e > 0 && ((l = P.getAbsoluteDistance(t[e - 1], n.margin, !1)), (r = Math.max(r, l))), o && e < f.length - 1 && ((l = P.getAbsoluteDistance(t[e + 1], n.margin, !0)), (r = Math.min(r, l)))),
          f.length > 1 && n.limit && (i && e > 0 && ((l = P.getAbsoluteDistance(t[e - 1], n.limit, !1)), (r = Math.min(r, l))), o && e < f.length - 1 && ((l = P.getAbsoluteDistance(t[e + 1], n.limit, !0)), (r = Math.max(r, l)))),
          n.padding && (0 === e && ((l = P.getAbsoluteDistance(0, n.padding[0], !1)), (r = Math.max(r, l))), e === f.length - 1 && ((l = P.getAbsoluteDistance(100, n.padding[1], !0)), (r = Math.min(r, l)))),
          a || (r = P.getStep(r)),
          !((r = c(r)) === t[e] && !s) && r
        );
      }
      ...
      d((S = N), n.cssClasses.target),
        ...
        (function (t, e) {
          ...
          (f = []), (g = []).push(F(r, t[0]));
          for (var i = 0; i < n.handles; i++) f.push(H(e, i)), (k[i] = i), g.push(F(r, t[i + 1]));
        })(n.connect, l),
        (x = n.events).fixed ||
          f.forEach(function (t, e) {
        ...
        x.tap &&
          G(
            ...
            function (t) {
              ...
              !1 !== r &&
                (n.events.snap || u(N, n.cssClasses.tap, n.animationDuration), ut(r, e, !0, !0), lt(), nt("slide", r, !0), nt("update", r, !0), n.events.snap ? tt(t, { handleNumbers: [r] }) : (nt("change", r, !0), nt("set", r, !0)));
            },
            {}
          ),
        x.hover &&
            ...
            if (!1 !== t && 0 !== e && e !== g.length - 1) {
              ...
              d(t, n.cssClasses.draggable),
                ...
                o.forEach(function (e) {
                  G(y.start, e, tt, { handles: s, handleNumbers: a, connect: t });
                });
            }
          }),
        ft(n.start),
      ...
      var mt = {
        ...
        disable: function (t) {
          null != t
            ? (f[t].setAttribute("disabled", ""), f[t].handle.removeAttribute("tabindex"))
        ...
        enable: function (t) {
          null != t
            ? (f[t].removeAttribute("disabled"), f[t].handle.setAttribute("tabindex", "0"))
