                ...
                8764: function (t) {
                    (t.exports = (function () {
                        ...
                        var g = {},
                            b = function (t) {
                                return new Promise(function (e) {
                                    ...
                                    (g.restoreFocusTimeout = setTimeout(
                                        function () {
                                            g.previousActiveElement instanceof
                                            HTMLElement
                            ...
                            U = function () {
                                return M(
                                    ".".concat(w.actions, " .").concat(w.cancel)
                                );
                            },
                            z = function () {
                                return M(
                                    ".".concat(w.actions, " .").concat(w.deny)
                                );
                            },
                            W = function () {
                            ...
                            J = function () {
                                ...
                                return p(new Set(n.concat(i))).filter(function (
                                    t
                                ) {
                                    return mt(t);
                                });
                            ...
                            yt = '\n <div aria-labelledby="'
                                ...
                                .concat(w.footer, '"></div>\n   <div class="')
                                .concat(
                                    w["timer-progress-bar-container"],
                                    '">\n     <div class="'
                                )
                                .concat(
                                    w["timer-progress-bar"],
                                    '"></div>\n   </div>\n </div>\n'
                                )
                                .replace(/(^|\n)\s*/g, ""),
                            wt = function () {
                        ...
                        var St = {
                            ...
                            Mt = function (t) {
                                var e = Dt(t.input);
                                "object" === r(t.customClass) &&
                                    rt(e, t.customClass.input);
                            },
                            It = function (t, e) {
                        ...
                        var En,
                            ...
                            Tn = Object.freeze({
                                ...
                                getTimerLeft: function () {
                                    return (
                                        g.timeout && g.timeout.getTimerLeft()
                                    );
                                },
                        ...
                        function Kn(t) {
                            (function (t) {
                                t.inputValidator ||
                                    ("email" === t.input &&
                                        (t.inputValidator = Wn.email),
                                    "url" === t.input &&
                                        (t.inputValidator = Wn.url));
                            })(t),
                                    ...
                                    function e() {
                                        if (
                                            ...
                                            for (
                                                ...
                                                o[i] = arguments[i];
                                            var r = Object.freeze(
                                                this.constructor.argsToParams(o)
                                            );
                                            (this.params = r),
