...
const Qe = { name: "applyStyles", enabled: !0, phase: "write", fn: li, effect: ui, requires: ["computeStyles"] };
function U(n) {
  return n.split("-")[0];
}
var ft = Math.max,
...
var pi = function (t, e) {
  return (t = typeof t == "function" ? t(Object.assign({}, e.rects, { placement: e.placement })) : t), Es(typeof t != "number" ? t : vs(t, Mt));
};
function _i(n) {
  var t,
    e = n.state,
...
const bs = { name: "arrow", enabled: !0, phase: "main", fn: _i, effect: mi, requires: ["popperOffsets"], requiresIfExists: ["preventOverflow"] };
function Lt(n) {
  return n.split("-")[1];
}
...
function vi(n) {
  var t = n.state,
    ...
    a = e.roundOffsets,
    l = a === void 0 ? !0 : a,
    h = { placement: U(t.placement), variation: Lt(t.placement), popper: t.elements.popper, popperRect: t.rects.popper, gpuAcceleration: i, isFixed: t.options.strategy === "fixed" };
  t.modifiersData.popperOffsets != null && (t.styles.popper = Object.assign({}, t.styles.popper, Tn(Object.assign({}, h, { offsets: t.modifiersData.popperOffsets, position: t.options.strategy, adaptive: o, roundOffsets: l })))),
    t.modifiersData.arrow != null && (t.styles.arrow = Object.assign({}, t.styles.arrow, Tn(Object.assign({}, h, { offsets: t.modifiersData.arrow, position: "absolute", adaptive: !1, roundOffsets: l })))),
    (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-placement": t.placement }));
}
const tn = { name: "computeStyles", enabled: !0, phase: "beforeWrite", fn: vi, data: {} };
var se = { passive: !0 };
function bi(n) {
  var t = n.state,
    e = n.instance,
...
const en = { name: "eventListeners", enabled: !0, phase: "write", fn: function () {}, effect: bi, data: {} };
...
function It(n, t) {
  ...
  var e = t,
    ...
    N = _ === wt ? S : b,
    C = { top: v.top - N.top + T.top, bottom: N.bottom - v.bottom + T.bottom, left: v.left - N.left + T.left, right: N.right - v.right + T.right },
...
function Si(n, t) {
  ...
  var f = _.reduce(function (A, m) {
    return (A[m] = It(n, { placement: m, boundary: i, rootBoundary: r, padding: o })[U(m)]), A;
  }, {});
    ...
    for (
      var i = e.mainAxis,
        ...
        g = [E].concat(O).reduce(function (At, J) {
          return At.concat(U(J) === ge ? Si(t, { placement: J, boundary: u, rootBoundary: p, padding: h, flipVariations: A, allowedAutoPlacements: m }) : J);
        }, []),
        v = t.rects.reference,
        b = t.rects.popper,
        y = new Map(),
      ...
      var D = g[C],
        ...
        ot = [L, R].indexOf(B) >= 0,
        at = ot ? "width" : "height",
        M = It(t, { placement: D, boundary: u, rootBoundary: p, altBoundary: _, padding: h }),
        F = ot ? ($ ? x : I) : $ ? R : L;
      v[at] > b[at] && (F = ue(F));
      var Zt = ue(F),
        ct = [];
...
const ys = { name: "flip", enabled: !0, phase: "main", fn: $i, requiresIfExists: ["offset"], data: { _skip: !1 } };
function On(n, t, e) {
...
function Li(n) {
  var t = n.state,
    ...
    u = Cn(l),
    p = Cn(h);
  (t.modifiersData[e] = { referenceClippingOffsets: l, popperEscapeOffsets: h, isReferenceHidden: u, hasPopperEscaped: p }),
    (t.attributes.popper = Object.assign({}, t.attributes.popper, { "data-popper-reference-hidden": u, "data-popper-escaped": p }));
}
const ws = { name: "hide", enabled: !0, phase: "main", requiresIfExists: ["preventOverflow"], fn: Li };
function Ii(n, t, e) {
  var s = U(n),
    ...
    o = r[0],
    a = r[1];
  return (o = o || 0), (a = (a || 0) * i), [I, x].indexOf(s) >= 0 ? { x: a, y: o } : { x: o, y: a };
}
function Pi(n) {
  var t = n.state,
    e = n.options,
...
const Os = { name: "offset", enabled: !0, phase: "main", requires: ["popperOffsets"], fn: Pi };
function Mi(n) {
  var t = n.state,
    e = n.name;
  t.modifiersData[e] = Ts({ reference: t.rects.reference, element: t.rects.popper, strategy: "absolute", placement: t.placement });
}
const on = { name: "popperOffsets", enabled: !0, phase: "read", fn: Mi, data: {} };
function Ri(n) {
  return n === "x" ? "y" : "x";
}
function xi(n) {
  var t = n.state,
    ...
    y = t.rects.reference,
    S = t.rects.popper,
    N = typeof m == "function" ? m(Object.assign({}, t.rects, { placement: t.placement })) : m,
    C = typeof N == "number" ? { mainAxis: N, altAxis: N } : Object.assign({ mainAxis: 0, altAxis: 0 }, N),
...
const Cs = { name: "preventOverflow", enabled: !0, phase: "main", fn: xi, requiresIfExists: ["offset"] };
function ki(n) {
...
function Wi(n, t, e) {
  ...
  var s = V(t),
    ...
    l = { x: 0, y: 0 };
  return (
    (s || (!s && !e)) && ((z(t) !== "body" || rn(r)) && (a = Vi(t)), V(t) ? ((l = $t(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop)) : r && (l.x = sn(r))),
...
function ve(n) {
  ...
  return function (a, l, h) {
    h === void 0 && (h = r);
    var u = { placement: "bottom", orderedModifiers: [], options: Object.assign({}, Nn, r), modifiersData: {}, elements: { reference: a, popper: l }, attributes: {}, styles: {} },
      p = [],
      _ = !1,
      f = {
        state: u,
        setOptions: function (T) {
          ...
          m(), (u.options = Object.assign({}, r, u.options, w)), (u.scrollParents = { reference: _t(a) ? Ft(a) : a.contextElement ? Ft(a.contextElement) : [], popper: Ft(l) });
        ...
        forceUpdate: function () {
          if (!_) {
            var T = u.elements,
              ...
              O = T.popper;
            if (Sn(w, O)) {
              (u.rects = { reference: Wi(w, Kt(O), u.options.strategy === "fixed"), popper: Ze(O) }),
                (u.reset = !1),
...
function rr(n, t) {
  return function e(s) {
    return ln(s, { delegateTarget: n }), e.oneOff && c.off(n, s.type, t), t.apply(n, [s]);
  };
}
function or(n, t, e) {
  return function s(i) {
    const r = n.querySelectorAll(t);
    for (let { target: o } = i; o && o !== this; o = o.parentNode) for (const a of r) if (a === o) return ln(i, { delegateTarget: o }), s.oneOff && c.off(n, i.type, t, e), e.apply(o, [i]);
  };
}
...
const Ar = "swipe",
  ...
  Ir = { endCallback: "(function|null)", leftCallback: "(function|null)", rightCallback: "(function|null)" };
class _e extends Ut {
  constructor(t, e) {
  ...
  _initEvents() {
    this._supportPointerEvents
      ? (c.on(this._element, Or, (t) => this._start(t)), c.on(this._element, Cr, (t) => this._end(t)), this._element.classList.add(Dr))
      : (c.on(this._element, Tr, (t) => this._start(t)), c.on(this._element, yr, (t) => this._move(t)), c.on(this._element, wr, (t) => this._end(t)));
  }
...
const Pr = "carousel",
  ...
  eo = { [Rr]: he, [xr]: Ot },
  no = { interval: 5e3, keyboard: !0, pause: "hover", ride: !1, touch: !0, wrap: !0 },
  so = { interval: "(number|boolean)", keyboard: "boolean", pause: "(string|boolean)", ride: "(boolean|string)", touch: "boolean", wrap: "boolean" };
class kt extends Y {
  constructor(t, e) {
    super(t, e),
      (this._interval = null),
      ...
      this._config.ride === js && this.cycle();
  }
  static get Default() {
    return no;
  }
  ...
  _addEventListeners() {
    this._config.keyboard && c.on(this._element, Hr, (t) => this._keydown(t)),
      this._config.pause === "hover" && (c.on(this._element, Wr, () => this.pause()), c.on(this._element, jr, () => this._maybeEnableCycle())),
  ...
  _slide(t, e = null) {
    ...
    const o = this._getItemIndex(r),
      a = (f) => c.trigger(this._element, f, { relatedTarget: r, direction: this._orderToDirection(t), from: this._getItemIndex(s), to: o });
...
c.on(document, ho, Ue, function (n) {
  ...
  for (const t of d.getMultipleElementsFromSelector(this)) Pt.getOrCreateInstance(t, { toggle: !1 }).toggle();
});
j(Pt);
const Pn = "dropdown",
  Ao = "bs.dropdown",
  ...
  Yo = "top",
  Uo = "bottom",
  zo = { autoClose: !0, boundary: "clippingParents", display: "dynamic", offset: [0, 2], popperConfig: null, reference: "toggle" },
  Go = { autoClose: "(boolean|string)", boundary: "(string|element)", display: "string", offset: "(array|string|function)", popperConfig: "(null|object|function)", reference: "(string|element|object)" };
class K extends Y {
  constructor(t, e) {
  ...
  show() {
    ...
    if (!c.trigger(this._element, No, t).defaultPrevented) {
      if ((this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(ko))) for (const s of [].concat(...document.body.children)) c.on(s, "mouseover", pe);
  ...
  _completeHide(t) {
    if (!c.trigger(this._element, Oo, t).defaultPrevented) {
      if ("ontouchstart" in document.documentElement) for (const s of [].concat(...document.body.children)) c.off(s, "mouseover", pe);
  ...
  _getPopperConfig() {
    ...
    return (this._inNavbar || this._config.display === "static") && (q.setDataAttribute(this._menu, "popper", "static"), (t.modifiers = [{ name: "applyStyles", enabled: !1 }])), { ...t, ...P(this._config.popperConfig, [t]) };
  }
  ...
  static clearMenus(t) {
    ...
    for (const s of e) {
      ...
      if (
        ...
        (i._menu.contains(t.target) && ((t.type === "keyup" && t.key === Mn) || /input|select|option|textarea|form/i.test(t.target.tagName)))
      )
        continue;
...
const Us = "backdrop",
  ...
  xn = "show",
  kn = `mousedown.bs.${Us}`,
  Xo = { className: "modal-backdrop", clickCallback: null, isAnimated: !1, isVisible: !0, rootElement: "body" },
  Qo = { className: "string", clickCallback: "(function|null)", isAnimated: "boolean", isVisible: "boolean", rootElement: "(element|string)" };
class zs extends Ut {
  constructor(t) {
...
class mt extends Y {
  ...
  show(t) {
    this._isShown ||
      ...
      ((this._isShown = !0), (this._isTransitioning = !0), this._scrollBar.hide(), document.body.classList.add(Bn), this._adjustDialog(), this._backdrop.show(() => this._showElement(t)));
  }
  hide() {
    !this._isShown ||
      this._isTransitioning ||
      c.trigger(this._element, ua).defaultPrevented ||
      ((this._isShown = !1), (this._isTransitioning = !0), this._focustrap.deactivate(), this._element.classList.remove(Fn), this._queueCallback(() => this._hideModal(), this._element, this._isAnimated()));
  }
  dispose() {
  ...
  _showElement(t) {
    ...
    const s = () => {
      this._config.focus && this._focustrap.activate(), (this._isTransitioning = !1), c.trigger(this._element, da, { relatedTarget: t });
    };
...
class Q extends Y {
  ...
  _initializeBackDrop() {
    ...
    return new zs({ className: Da, isVisible: e, isAnimated: !0, rootElement: this._element.parentNode, clickCallback: e ? t : null });
  }
  _initializeFocusTrap() {
    return new Gs({ trapElement: this._element });
  }
...
const Ka = "TemplateFactory",
  Ya = { allowList: ti, content: {}, extraClass: "", html: !1, sanitize: !0, sanitizeFn: null, template: "<div></div>" },
  Ua = { allowList: "object", content: "object", extraClass: "(string|function)", html: "boolean", sanitize: "boolean", sanitizeFn: "(null|function)", template: "string" },
...
const qa = "tooltip",
  ...
  lc = "mouseenter",
  uc = "mouseleave",
  hc = { AUTO: "auto", TOP: "top", RIGHT: H() ? "left" : "right", BOTTOM: "bottom", LEFT: H() ? "right" : "left" },
  dc = {
    allowList: ti,
    animation: !0,
...
class vt extends Y {
  ...
  show() {
    ...
    if (
      (this._element.ownerDocument.documentElement.contains(this.tip) || (r.append(i), c.trigger(this._element, this.constructor.eventName(rc))),
  ...
  hide() {
    ...
    if ((this._getTipElement().classList.remove(ae), "ontouchstart" in document.documentElement)) for (const i of [].concat(...document.body.children)) c.off(i, "mouseover", pe);
...
const vc = "scrollspy",
  ...
  $c = ".dropdown",
  Lc = ".dropdown-toggle",
  Ic = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
  Pc = { offset: "(number|null)", rootMargin: "string", smoothScroll: "boolean", target: "element", threshold: "array" };
class Xt extends Y {
  constructor(t, e) {
    super(t, e),
  ...
  _process(t) {
    this._activeTarget !== t && (this._clearActiveClass(this._config.target), (this._activeTarget = t), t.classList.add(yt), this._activateParents(t), c.trigger(this._element, Tc, { relatedTarget: t }));
  }
  _activateParents(t) {
    ...
    for (const e of d.parents(t, Cc)) for (const s of d.prev(e, Dc)) s.classList.add(yt);
  }
  _clearActiveClass(t) {
...
class gt extends Y {
  ...
  _activate(t, e) {
    ...
    const s = () => {
      ...
      t.removeAttribute("tabindex"), t.setAttribute("aria-selected", !0), this._toggleDropDown(t, !0), c.trigger(t, Hc, { relatedTarget: e });
    };
  ...
  _deactivate(t, e) {
    ...
    const s = () => {
      ...
      t.setAttribute("aria-selected", !1), t.setAttribute("tabindex", "-1"), this._toggleDropDown(t, !1), c.trigger(t, kc, { relatedTarget: e });
    };
    this._queueCallback(s, t, t.classList.contains(es));
  }
  _keydown(t) {
...
const ul = Object.freeze(
  Object.defineProperty({ __proto__: null, Alert: zt, Button: Gt, Carousel: kt, Collapse: Pt, Dropdown: K, Modal: mt, Offcanvas: Q, Popover: Ae, ScrollSpy: Xt, Tab: gt, Toast: Qt, Tooltip: vt }, Symbol.toStringTag, { value: "Module" })
);
try {
  window.bootstrap = ul;
} catch {}
