              ...
              return (
                ...
                (e.prototype.removeField = function (e) {
                  ...
                  var t = this.elements[e],
                    i = this.fields[e];
                  return delete this.elements[e], delete this.fields[e], this.emit("core.field.removed", { elements: t, field: e, options: i }), this;
                }),
                ...
                (e.prototype.validateElement = function (e, t) {
                  ...
                  var n = this.elements[e];
                  if (this.filter.execute("element-ignored", !1, [e, t, n])) return this.emit("core.element.ignored", { element: t, elements: n, field: e }), Promise.resolve("Ignored");
                  ...
                  return this.waterfall(o)
                    ...
                    .catch(function (r) {
                      return i.emit("core.element.notvalidated", { element: t, elements: n, field: e }), Promise.resolve(r);
                    });
                }),
                (e.prototype.executeValidator = function (e, t, i, n) {
                  ...
                  if (((n.message = this.filter.execute("validator-message", n.message, [this.locale, e, a])), !this.validators[a] || !1 === n.enabled))
                    return this.emit("core.validator.validated", { element: t, elements: o, field: e, result: this.normalizeResult(e, a, { valid: !0 }), validator: a }), Promise.resolve("Valid");
                  var s = this.validators[a],
                    l = this.getElementValue(e, t, a);
                  if (!this.filter.execute("field-should-validate", !0, [e, t, l, i])) return this.emit("core.validator.notvalidated", { element: t, elements: o, field: e, validator: i }), Promise.resolve("NotValidated");
                  this.emit("core.validator.validating", { element: t, elements: o, field: e, validator: i });
                  var d = s().validate({ element: t, elements: o, field: e, l10n: this.localization, options: n, value: l });
                  if ("function" == typeof d.then)
                    return d.then(function (n) {
                      var a = r.normalizeResult(e, i, n);
                      return r.emit("core.validator.validated", { element: t, elements: o, field: e, result: a, validator: i }), a.valid ? "Valid" : "Invalid";
                    });
                  var c = this.normalizeResult(e, i, d);
                  return this.emit("core.validator.validated", { element: t, elements: o, field: e, result: c, validator: i }), Promise.resolve(c.valid ? "Valid" : "Invalid");
                }),
                  ...
                  switch (i) {
                    case "NotValidated":
                      s.forEach(function (i) {
                        return r.emit("core.validator.notvalidated", { element: t, elements: o, field: e, validator: i });
                      }),
                        this.emit("core.element.notvalidated", { element: t, elements: o, field: e });
                      break;
                    case "Validating":
                      s.forEach(function (i) {
                        return r.emit("core.validator.validating", { element: t, elements: o, field: e, validator: i });
                      }),
                        this.emit("core.element.validating", { element: t, elements: o, field: e });
                      break;
                    case "Valid":
                      s.forEach(function (i) {
                        return r.emit("core.validator.validated", { element: t, elements: o, field: e, result: { message: a[i].message, valid: !0 }, validator: i });
                      }),
                        this.emit("core.element.validated", { element: t, elements: o, field: e, valid: !0 });
                      break;
                    case "Invalid":
                      s.forEach(function (i) {
                        return r.emit("core.validator.validated", { element: t, elements: o, field: e, result: { message: a[i].message, valid: !1 }, validator: i });
                      }),
                  ...
                  if (t) {
                    ...
                    i.forEach(function (e) {
                      "radio" === n || "checkbox" === n
                        ...
                        : (e.setAttribute("value", ""), (e instanceof HTMLInputElement || e instanceof HTMLTextAreaElement) && (e.value = ""));
                    });
                  }
                ...
                (e.prototype.disableValidator = function (e, t) {
                  ...
                  var i = this.elements[e];
                  return this.toggleValidator(!1, e, t), this.emit("core.validator.disabled", { elements: i, field: e, formValidation: this, validator: t }), this;
                }),
                (e.prototype.enableValidator = function (e, t) {
                  if (!this.fields[e]) return this;
                  var i = this.elements[e];
                  return this.toggleValidator(!0, e, t), this.emit("core.validator.enabled", { elements: i, field: e, formValidation: this, validator: t }), this;
                }),
              ...
              return (
                ...
                (t.prototype.handleElementValidated = function (e) {
                  ...
                  if (("checkbox" === t || "radio" === t) && e.elements.length > 1 && s(e.element, "form-check-input")) {
                    ...
                    s(i, "form-check") && s(i, "form-check-inline") && a(i, { "is-invalid": !e.valid, "is-valid": e.valid });
                  }
                }),
                (t.prototype.onIconPlaced = function (e) {
                  ...
                  s(t, "input-group") &&
                    (t.parentElement.insertBefore(e.iconElement, t.nextSibling), e.element.nextElementSibling && s(e.element.nextElementSibling, "input-group-text") && a(e.iconElement, { "fv-plugins-icon-input-group": !0 }));
                  var i = e.element.getAttribute("type");
                  if ("checkbox" === i || "radio" === i) {
                    var n = t.parentElement;
                    s(t, "form-check")
                      ? (a(e.iconElement, { "fv-plugins-icon-check": !0 }), t.parentElement.insertBefore(e.iconElement, t.nextSibling))
                      : s(t.parentElement, "form-check") && (a(e.iconElement, { "fv-plugins-icon-check": !0 }), n.parentElement.insertBefore(e.iconElement, n.nextSibling));
                  }
                }),
            ...
            l = (function (e) {
              function t(t) {
                ...
                return (
                  ...
                  (i.opts = Object.assign({}, { defaultMessageContainer: !0, eleInvalidClass: "", eleValidClass: "", rowClasses: "", rowValidatingClass: "" }, t)),
            ...
            a = (function (e) {
              ...
              return (
                ...
                (t.prototype.prepareElementContainer = function (e, t, i) {
                  ...
                  n.appendChild(a),
                    o(a, { "fv-plugins-message-container": !0, "fv-plugins-message-container--enabled": this.isEnabled, "fv-plugins-message-container--disabled": !this.isEnabled }),
                    ...
                    if (s || e.result.valid)
                      s && !e.result.valid
                        ? ((s.innerHTML = this.getMessage(e.result)),
                          this.core.emit("plugins.message.displayed", { element: e.element, field: e.field, message: e.result.message, messageElement: s, meta: e.result.meta, validator: e.validator }))
                      ...
                      (l.innerHTML = this.getMessage(e.result)),
                        ...
                        a.appendChild(l),
                        this.core.emit("plugins.message.displayed", { element: e.element, field: e.field, message: e.result.message, messageElement: l, meta: e.result.meta, validator: e.validator });
                    }
                  }
                }),
