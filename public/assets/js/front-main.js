...
(window.isRtl = window.Helpers.isRtl()),
  ...
  (function () {
    ...
    window.templateCustomizer &&
      ...
      (s = s.querySelector("i")),
      "light" === n
        ? (s.classList.add("ri-sun-line"), new bootstrap.Tooltip(s, { title: "Light Mode", fallbackPlacements: ["bottom"] }))
        : "dark" === n
        ? (s.classList.add("ri-moon-clear-line"), new bootstrap.Tooltip(s, { title: "Dark Mode", fallbackPlacements: ["bottom"] }))
        : (s.classList.add("ri-computer-line"), new bootstrap.Tooltip(s, { title: "System Mode", fallbackPlacements: ["bottom"] }))),
      "system" === (l = n) && (l = window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"),
    ...
    function c(t) {
      "show.bs.collapse" == t.type || "show.bs.collapse" == t.type
        ? (t.target.closest(".accordion-item").classList.add("active"), t.target.closest(".accordion-item").previousElementSibling?.classList.add("previous-active"))
        : (t.target.closest(".accordion-item").classList.remove("active"), t.target.closest(".accordion-item").previousElementSibling?.classList.remove("previous-active"));
    }
    [].slice.call(document.querySelectorAll(".accordion")).map(function (t) {
      t.addEventListener("show.bs.collapse", c), t.addEventListener("hide.bs.collapse", c);
    });
  })();
