            ...
            !(function (e) {
              ...
              function w(t, e) {
                ...
                if (
                  ...
                  (this.method = ((n = (o = e.method || this.method || "GET").toUpperCase()), v.indexOf(n) > -1 ? n : o)),
    ...
    return (
      (function () {
        ...
        class b extends n {
          ...
          addResource(t, e, o, n) {
            let r = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : { silent: !1 };
          ...
          addResources(t, e, o) {
            let n = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : { silent: !1 };
            for (const n in o) ("string" != typeof o[n] && "[object Array]" !== Object.prototype.toString.apply(o[n])) || this.addResource(t, e, n, o[n], { silent: !0 });
            n.silent || this.emit("added", t, e, o);
          }
          addResourceBundle(t, e, o, n, r) {
            let i = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : { silent: !1 },
              s = [t, e];
            t.indexOf(".") > -1 && ((s = t.split(".")), (n = o), (o = e), (e = s[1])), this.addNamespaces(e);
            let a = c(this.data, s) || {};
            n ? p(a, o, r) : (a = { ...a, ...o }), u(this.data, s, a), i.silent || this.emit("added", t, e, o);
          }
        ...
        class x extends n {
          ...
          translate(t, e, o) {
            ...
            if (l && "cimode" === l.toLowerCase()) {
              if (u) {
                ...
                return n ? { res: `${a}${t}${i}`, usedKey: i, exactUsedKey: i, usedLng: l, usedNS: a, usedParams: this.getUsedParamsDetails(e) } : `${a}${t}${i}`;
              }
              return n ? { res: i, usedKey: i, exactUsedKey: i, usedLng: l, usedNS: a, usedParams: this.getUsedParamsDetails(e) } : i;
            }
            ...
            if (y && p && "string" != typeof p && "boolean" != typeof p && "number" != typeof p && ["[object Number]", "[object Function]", "[object RegExp]"].indexOf(d) < 0 && ("string" != typeof g || "[object Array]" !== d)) {
              if (!e.returnObjects && !this.options.returnObjects) {
                ...
                const t = this.options.returnedObjectHandler ? this.options.returnedObjectHandler(h, p, { ...e, ns: s }) : `key '${i} (${this.language})' returned an object instead of string.`;
              ...
              if (r) {
                ...
                for (const t in p)
                  if (Object.prototype.hasOwnProperty.call(p, t)) {
                    const i = `${n}${r}${t}`;
                    (o[t] = this.translate(i, { ...e, joinArrays: !1, ns: s })), o[t] === i && (o[t] = p[t]);
                  }
                p = o;
              }
              ...
              if (s || n || b) {
                ...
                if ("fallback" === this.options.saveMissingTo && o && o[0]) for (let e = 0; e < o.length; e++) t.push(o[e]);
              ...
              (p = this.extendTranslation(p, t, e, c, o)),
                ...
                (s || n) &&
                  ...
                  (p = "v1" !== this.options.compatibilityAPI ? this.options.parseMissingKeyHandler(this.options.appendNamespaceToMissingKey ? `${a}:${i}` : i, n ? p : void 0) : this.options.parseMissingKeyHandler(p));
            }
            return n ? ((c.res = p), (c.usedParams = this.getUsedParamsDetails(e)), c) : p;
          }
          extendTranslation(t, e, o, n, r) {
            var i = this;
            if (this.i18nFormat && this.i18nFormat.parse) t = this.i18nFormat.parse(t, { ...this.options.interpolation.defaultVariables, ...o }, o.lng || this.language || n.usedLng, n.usedNS, n.usedKey, { resolved: n });
              ...
              if ((this.options.interpolation.defaultVariables && (l = { ...this.options.interpolation.defaultVariables, ...l }), (t = this.interpolator.interpolate(t, l, o.lng || this.language, o)), s)) {
                const e = t.match(this.interpolator.nestingRegexp);
            ...
            return (
              null != t && a && a.length && !1 !== o.applyPostProcessor && (t = v.handle(a, t, e, this.options && this.options.postProcessPassResolved ? { i18nResolved: { ...n, usedParams: this.getUsedParamsDetails(o) }, ...o } : o, this)),
              t
            );
          }
          resolve(t) {
                ...
                u.forEach((t) => {
                  this.isValidLookup(e) ||
                    ...
                    !w[`${f[0]}-${t}`] &&
                      ...
                      ((w[`${f[0]}-${t}`] = !0),
                      this.logger.warn(
                        `key "${o}" for languages "${f.join(", ")}" won't get resolved as namespace "${i}" was not yet loaded`,
          ...
          getUsedParamsDetails() {
            ...
            let n = o ? t.replace : t;
            if ((o && void 0 !== t.count && (n.count = t.count), this.options.interpolation.defaultVariables && (n = { ...this.options.interpolation.defaultVariables, ...n }), !o)) {
              n = { ...n };
          ...
          static hasDefaultValue(t) {
            for (const e in t) if (Object.prototype.hasOwnProperty.call(t, e) && "defaultValue" === e.substring(0, 12) && void 0 !== t[e]) return !0;
            return !1;
          }
        }
        function S(t) {
            ...
            if ("string" == typeof t && t.indexOf("-") > -1) {
              ...
              return (
                this.options.lowerCaseLng
                  ...
                  : 2 === o.length
                  ? ((o[0] = o[0].toLowerCase()), (o[1] = o[1].toUpperCase()), e.indexOf(o[1].toLowerCase()) > -1 && (o[1] = S(o[1].toLowerCase())))
                  : 3 === o.length &&
                    ((o[0] = o[0].toLowerCase()),
        ...
        class E {
          constructor(t) {
            ...
            (this.languageUtils = t),
              ...
              (this.options.compatibilityJSON && !j.includes(this.options.compatibilityJSON)) ||
          ...
          getRule(t) {
            ...
            if (this.shouldUseIntlApi())
              try {
                return new Intl.PluralRules(m("dev" === t ? "en" : t), { type: e.ordinal ? "ordinal" : "cardinal" });
              } catch (t) {
                return;
              }
        ...
        class N {
          ...
          interpolate(t, e, o, n) {
            ...
            const c = (t) => {
              if (t.indexOf(this.formatSeparator) < 0) {
                ...
                return this.alwaysFormat ? this.format(r, void 0, o, { ...n, ...e, interpolationkey: t }) : r;
              }
              const r = t.split(this.formatSeparator),
                i = r.shift().trim(),
                s = r.join(this.formatSeparator).trim();
              return this.format(C(e, l, i, this.options.keySeparator, this.options.ignoreJSONStructure), s, o, { ...n, ...e, interpolationkey: i });
            };
            this.resetRegExp();
            ...
            return (
              [
                ...
                { regex: this.regexp, safeValue: (t) => (this.escapeValue ? u(this.escape(t)) : u(t)) },
              ].forEach((e) => {
          ...
          nest(t, e) {
            ...
            for (; (o = this.nestingRegexp.exec(t)); ) {
              let l = [];
              (r = { ...i }), (r = r.replace && "string" != typeof r.replace ? r.replace : r), (r.applyPostProcessor = !1), delete r.defaultValue;
              let u = !1;
              ...
              "string" != typeof n && (n = a(n)),
                ...
                u && (n = l.reduce((t, e) => this.format(t, e, i.lng, { ...i, interpolationkey: o[1].trim() }), n.trim())),
                (t = t.replace(o[0], n)),
          ...
          constructor() {
            ...
            (this.logger = o.create("formatter")),
              ...
              (this.formats = {
                ...
                currency: T((t, e) => {
                  const o = new Intl.NumberFormat(t, { ...e, style: "currency" });
                  return (t) => o.format(t);
                }),
                datetime: T((t, e) => {
        ...
        class D extends n {
              ...
              t.forEach((t) => {
                ...
                e.forEach((e) => {
                  ...
                  !o.reload && this.store.hasResourceBundle(t, e)
                    ? (this.state[s] = 2)
                    : this.state[s] < 0 || (1 === this.state[s] ? void 0 === i[s] && (i[s] = !0) : ((this.state[s] = 1), (n = !1), void 0 === i[s] && (i[s] = !0), void 0 === r[s] && (r[s] = !0), void 0 === a[e] && (a[e] = !0)));
                }),
                  n || (s[t] = !0);
              }),
              (Object.keys(r).length || Object.keys(i).length) && this.queue.push({ pending: i, pendingCount: Object.keys(i).length, loaded: {}, errors: [], callback: n }),
              { toLoad: Object.keys(r), pending: Object.keys(i), toLoadLanguages: Object.keys(s), toLoadNamespaces: Object.keys(a) }
            );
          }
          loaded(t, e, o) {
            const n = t.split("|"),
          ...
          read(t, e, o) {
            ...
            if (this.readingCalls >= this.maxParallelReads) return void this.waitingReads.push({ lng: t, ns: e, fcName: o, tried: n, wait: r, callback: i });
            this.readingCalls++;
            const s = (s, a) => {
        ...
        class F extends n {
          ...
          init() {
            ...
            if (
              ...
              "v1" !== this.options.compatibilityAPI && (this.options.interpolation = { ...r.interpolation, ...this.options.interpolation }),
              ...
              (s.logger = o),
                ...
                (s.languageUtils = n),
                (s.pluralResolver = new E(n, { prepend: this.options.pluralSeparator, compatibilityJSON: this.options.compatibilityJSON, simplifyPluralSuffix: this.options.simplifyPluralSuffix })),
                !e ||
                  (this.options.interpolation.format && this.options.interpolation.format !== r.interpolation.format) ||
                  ((s.formatter = i(e)), s.formatter.init(s, this.options), (this.options.interpolation.format = s.formatter.format.bind(s.formatter))),
          ...
          cloneInstance() {
            ...
            return (
              ...
              o && ((r.store = new b(this.store.data, n)), (r.services.resourceStore = r.store)),
        ...
        var W = function (t, e) {
          ...
          Y = function (t, e, o) {
            var n = function (t) {
              if (!t.ok) return o(t.statusText || "Error", { status: t.status });
              t.text()
                .then(function (e) {
              ...
              H && 0 !== e.indexOf("file:")
                ? (function (t, e, o, n) {
                    ...
                    "undefined" == typeof window &&
                      ...
                      (r["User-Agent"] = "i18next-http-backend (node/".concat(global.process.version, "; ").concat(global.process.platform, " ").concat(global.process.arch, ")")),
                      o && (r["Content-Type"] = "application/json");
                    var i = "function" == typeof t.requestOptions ? t.requestOptions(o) : t.requestOptions,
                      s = X({ method: o ? "POST" : "GET", body: o ? t.stringify(o) : void 0, headers: r }, Q ? {} : i);
                    try {
                      Y(e, s, n);
                    } catch (t) {
                ...
                ? (function (t, e, o, n) {
                    ...
                    try {
                      ...
                      if ((i = "function" == typeof i ? i() : i)) for (var s in i) r.setRequestHeader(s, i[s]);
                      (r.onreadystatechange = function () {
                        r.readyState > 3 && n(r.status >= 400 ? r.statusText : null, { status: r.status, data: r.responseText });
                      }),
                        r.send(o);
                    } catch (t) {
        ...
        function rt(t, e, o) {
          return (e = it(e)) in t ? Object.defineProperty(t, e, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (t[e] = o), t;
        }
        function it(t) {
          var e = (function (t, e) {
                ...
                value: function (t, e, o, n, r) {
                  ...
                  "function" == typeof this.options.loadPath && (a = this.options.loadPath(t, o)),
                    (a = (function (t) {
                      ...
                      if (!i) return r(null, {});
                      var a = s.services.interpolator.interpolate(i, { lng: t.join("+"), ns: o.join("+") });
                      s.loadUrl(a, r, e, n);
                    });
                },
              },
                ...
                value: function (t, e, o, n, r) {
                  ...
                  if (this.options.addPath) {
                    ...
                    t.forEach(function (o) {
                      ...
                      var c = i.services.interpolator.interpolate(n, { lng: o, ns: e });
          ...
          Ot = {
            ...
            lookup: function (t) {
              ...
              if ("undefined" != typeof navigator) {
                if (navigator.languages) for (var o = 0; o < navigator.languages.length; o++) e.push(navigator.languages[o]);
                      ...
                      (this.options = (function (t) {
                        return (
                          ht.call(ft.call(arguments, 1), function (e) {
                            if (e) for (var o in e) void 0 === t[o] && (t[o] = e[o]);
                          }),
                          t
                        );
                      })(e, this.options || {}, {
