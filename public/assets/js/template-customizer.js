                    ...
                    if (this._hasControls("themes")) {
                      ...
                      if (s) {
                        ...
                        this._loadStylesheets(
                          ((a = {}), (n = r), (o = document.querySelector(".template-customizer-theme-css")), (n = g(n)) in a ? Object.defineProperty(a, n, { value: o, enumerable: !0, configurable: !0, writable: !0 }) : (a[n] = o), a),
                          i || function () {}
                        ),
                ...
                },
                {
                  ...
                  value: function () {
                    if (this._hasControls("themes"))
                      ...
                      this._insertStylesheet(
                        "template-customizer-theme-css",
                        this.pathResolver(this.settings.themesPath + this.settings.cssFilenamePattern.replace("%name%", t || this.settings.defaultTheme.name + ("light" !== this.settings.style ? "-".concat(this.settings.style) : "")))
                      );
                    }
                  },
                },
