              ...
              (t.containerWidth = Math.round(n.width)),
                ...
                !t.settings.suppressScrollX && t.containerWidth + t.settings.scrollXMarginOffset < t.contentWidth
                  ? ((t.scrollbarXActive = !0),
                    ...
                    (t.scrollbarXLeft = g(((t.negativeScrollAdjustment + r.scrollLeft) * (t.railXWidth - t.scrollbarXWidth)) / (t.contentWidth - t.containerWidth))))
                ...
                !t.settings.suppressScrollY && t.containerHeight + t.settings.scrollYMarginOffset < t.contentHeight
                  ? ((t.scrollbarYActive = !0),
                    ...
                    (t.scrollbarYTop = g((i * (t.railYHeight - t.scrollbarYHeight)) / (t.contentHeight - t.containerHeight))))
                ...
                (function (t, r) {
                  ...
                  r.isScrollbarYUsingRight
                    ? r.isRtl
                      ? (l.right = r.contentWidth - (r.negativeScrollAdjustment + t.scrollLeft) - r.scrollbarYRight - r.scrollbarYOuterWidth - 9)
                      : (l.right = r.scrollbarYRight - t.scrollLeft)
                    : r.isRtl
                    ? (l.left = r.negativeScrollAdjustment + t.scrollLeft + 2 * r.containerWidth - r.contentWidth - r.scrollbarYLeft - r.scrollbarYOuterWidth)
                ...
                t.scrollbarXActive ? r.classList.add(s.state.active("x")) : (r.classList.remove(s.state.active("x")), (t.scrollbarXWidth = 0), (t.scrollbarXLeft = 0), (r.scrollLeft = !0 === t.isRtl ? t.contentWidth : 0)),
                t.scrollbarYActive ? r.classList.add(s.state.active("y")) : (r.classList.remove(s.state.active("y")), (t.scrollbarYHeight = 0), (t.scrollbarYTop = 0), (r.scrollTop = 0));
            }
            function Y(t, e) {
            ...
            function y(t, e) {
              ...
              function w(e, o) {
                (b = p[u]),
                  ...
                  (g = e[n]),
                  (v = (t[i] - t[r]) / (t[l] - t[a])),
                  o ? t.event.bind(t.ownerDocument, "touchmove", Y) : (t.event.bind(t.ownerDocument, "mousemove", Y), t.event.once(t.ownerDocument, "mouseup", y), e.preventDefault()),
            ...
            var w = {
                    ...
                    if (
                      ...
                      e.settings.useBothWheelAxes
                        ? e.scrollbarYActive && !e.scrollbarXActive
                          ? (o ? (r.scrollTop -= o * e.settings.wheelSpeed) : (r.scrollTop += l * e.settings.wheelSpeed), (a = !0))
                          : e.scrollbarXActive && !e.scrollbarYActive && (l ? (r.scrollLeft += l * e.settings.wheelSpeed) : (r.scrollLeft -= o * e.settings.wheelSpeed), (a = !0))
                        : ((r.scrollTop -= o * e.settings.wheelSpeed), (r.scrollLeft += l * e.settings.wheelSpeed)),
                        m(e),
                        (a =
                          a ||
                          (function (t, i) {
                ...
                touch: function (e) {
                  if (v.supportsTouch || v.supportsIePointer) {
                    var r = e.element,
                      ...
                      o = null;
                    v.supportsTouch
                      ? (e.event.bind(r, "touchstart", u), e.event.bind(r, "touchmove", d), e.event.bind(r, "touchend", f))
                      : v.supportsIePointer &&
                        (window.PointerEvent
                          ? (e.event.bind(r, "pointerdown", u), e.event.bind(r, "pointermove", d), e.event.bind(r, "pointerup", f))
                          : window.MSPointerEvent && (e.event.bind(r, "MSPointerDown", u), e.event.bind(r, "MSPointerMove", d), e.event.bind(r, "MSPointerUp", f)));
                  }
                  function a(t, i) {
              ...
              X = function (i, n) {
                ...
                (this.isRtl = "rtl" === t(i).direction),
                  ...
                  (this.isNegativeScroll = ((a = i.scrollLeft), null, (i.scrollLeft = -1), (c = i.scrollLeft < 0), (i.scrollLeft = a), c)),
                ...
                (this.scrollbarXBottom = parseInt(d.bottom, 10)),
                  isNaN(this.scrollbarXBottom) ? ((this.isScrollbarXUsingBottom = !1), (this.scrollbarXTop = g(d.top))) : (this.isScrollbarXUsingBottom = !0),
                ...
                (this.scrollbarYRight = parseInt(p.right, 10)),
                  isNaN(this.scrollbarYRight) ? ((this.isScrollbarYUsingRight = !1), (this.scrollbarYLeft = g(p.left))) : (this.isScrollbarYUsingRight = !0),
