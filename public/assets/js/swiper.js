  ...
  return (function () {
            ...
            c[a] && (c[a].swiperSlideSize = L),
              ...
              s.centeredSlides
                ? ((S = S + L / 2 + T / 2 + x),
                  ...
                  m.push(S))
                : (s.roundLengths && (S = Math.floor(S)), (C - Math.min(e.params.slidesPerGroupSkip, C)) % e.params.slidesPerGroup == 0 && u.push(S), m.push(S), (S = S + L + x)),
              (e.virtualSize += L + x),
              (T = L),
              (C += 1);
          }
    ...
    var H = {
        slideTo: function (e, t, s, a, i) {
          ...
          if ((r.animating && l.preventInteractionOnTransition) || (!h && !a && !i) || r.destroyed) return !1;
      ...
      X = {
        ...
        loopFix: function (e) {
          ...
          d.length < f + v
            ...
            : b && "row" === m.grid.fill && w("Swiper Loop Warning: Loop mode is not compatible with grid.fill = `row`");
          const y = [],
            E = [];
          let x = o.activeIndex;
    ...
    function B(e) {
      ...
      let w = !0;
      p.matches(i.focusableElements) && ((w = !1), "SELECT" === p.nodeName && (i.isTouched = !1)), s.activeElement && s.activeElement.matches(i.focusableElements) && s.activeElement !== p && s.activeElement.blur();
    ...
    function R(e) {
      ...
      if (!s.allowTouchMove) return p.target.matches(a.focusableElements) || (s.allowClick = !1), void (a.isTouched && (Object.assign(n, { startX: u, startY: m, currentX: u, currentY: m }), (a.touchStartTime = c())));
      ...
      if (void 0 === a.isScrolling) {
        ...
        (s.isHorizontal() && n.currentY === n.startY) || (s.isVertical() && n.currentX === n.startX)
          ? (a.isScrolling = !1)
          : h * h + f * f >= 25 && ((e = (180 * Math.atan2(Math.abs(f), Math.abs(h))) / Math.PI), (a.isScrolling = s.isHorizontal() ? e > i.touchAngle : 90 - e > i.touchAngle));
      }
      ...
      if (
        ...
        g > 0
          ? (b && y && a.allowThresholdMove && a.currentTranslate > (i.centeredSlides ? s.minTranslate() - s.slidesSizesGrid[s.activeIndex + 1] : s.minTranslate()) && s.loopFix({ direction: "prev", setTranslate: !0, activeSlideIndex: 0 }),
            a.currentTranslate > s.minTranslate() && ((E = !1), i.resistance && (a.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + a.startTranslate + g) ** x)))
          : g < 0 &&
            (b &&
              y &&
              a.allowThresholdMove &&
              a.currentTranslate < (i.centeredSlides ? s.maxTranslate() + s.slidesSizesGrid[s.slidesSizesGrid.length - 1] : s.maxTranslate()) &&
              s.loopFix({ direction: "next", setTranslate: !0, activeSlideIndex: s.slides.length - ("auto" === i.slidesPerView ? s.slidesPerViewDynamic() : Math.ceil(parseFloat(i.slidesPerView, 10))) }),
            a.currentTranslate < s.maxTranslate() && ((E = !1), i.resistance && (a.currentTranslate = s.maxTranslate() + 1 - (s.maxTranslate() - a.startTranslate - g) ** x))),
      ...
      return function (s) {
        ...
        "object" == typeof i && null !== i
          ? (!0 === e[a] && (e[a] = { enabled: !0 }),
            ...
            a in e && "enabled" in i ? ("object" != typeof e[a] || "enabled" in e[a] || (e[a].enabled = !0), e[a] || (e[a] = { enabled: !1 }), m(t, s)) : m(t, s))
          : m(t, s);
      };
    }
    const J = {
        ...
        events: {
          attachEvents: function () {
            const e = this,
              { params: t } = e;
            (e.onTouchStart = B.bind(e)), (e.onTouchMove = R.bind(e)), (e.onTouchEnd = q.bind(e)), (e.onDocumentTouchStart = W.bind(e)), t.cssMode && (e.onScroll = _.bind(e)), (e.onClick = V.bind(e)), (e.onLoad = j.bind(e)), U(e, "on");
          },
        ...
        breakpoints: {
          setBreakpoint: function () {
            ...
            Object.assign(e, { allowTouchMove: e.params.allowTouchMove, allowSlideNext: e.params.allowSlideNext, allowSlidePrev: e.params.allowSlidePrev }),
              ...
              s && (u ? (e.loopDestroy(), e.loopCreate(t), e.updateSlides()) : !h && g ? (e.loopCreate(t), e.updateSlides()) : h && !g && e.loopDestroy()),
              e.emit("breakpoint", l);
          },
    ...
    class te {
      constructor() {
        ...
        const d = {};
        o.modules.forEach((e) => {
          e({ params: t, swiper: o, extendParams: Q(t, d), on: o.on.bind(o), once: o.once.bind(o), off: o.off.bind(o), emit: o.emit.bind(o) });
        });
        const c = m({}, Z, d);
        return (
          (o.params = m({}, c, ee, t)),
        ...
        function (e) {
          ...
          const r = [],
            ...
            o = function (e, s) {
              ...
              a.observe(e, { attributes: void 0 === s.attributes || s.attributes, childList: void 0 === s.childList || s.childList, characterData: void 0 === s.characterData || s.characterData }), r.push(a);
            };
    ...
    const me = [
      function (e) {
        ...
        function d(e, t) {
          ...
          let i;
          return (
            a.renderSlide ? ((i = a.renderSlide.call(s, e, t)), "string" == typeof i && ((o.innerHTML = i), (i = o.children[0]))) : (i = s.isElement ? b("swiper-slide") : b("div", s.params.slideClass)),
        ...
        function c(e) {
          ...
          if (
            (r && f >= b ? ((y -= b), i || (x += s.slidesGrid[0])) : r && f < b && ((y = -b), i && (x += s.slidesGrid[0])),
      ...
      function (e) {
        ...
        function f(e) {
          return !(
            ...
            (!(e.delta >= 6 && c() - p < 60) &&
              (e.direction < 0 ? (t.isEnd && !t.params.loop) || t.animating || (t.slideNext(), i("scroll", e.raw)) : (t.isBeginning && !t.params.loop) || t.animating || (t.slidePrev(), i("scroll", e.raw)), (p = new r.Date().getTime()), 1))
          );
        }
        function g(e) {
          let s = e,
      ...
      function (e) {
        ...
        function m() {
          ...
          "string" == typeof e.el && t.isElement && (s = t.el.querySelector(e.el)),
            ...
            s &&
              0 !== s.length &&
              (t.params.uniqueNavElements && "string" == typeof e.el && Array.isArray(s) && s.length > 1 && ((s = [...t.el.querySelectorAll(e.el)]), s.length > 1 && (s = s.filter((e) => S(e, ".swiper")[0] === t.el)[0])),
      ...
      function (e) {
        ...
        function S(e) {
          const { scrollbar: s, wrapperEl: a } = t,
            { el: r, dragEl: n } = s;
          m && (e.preventDefault ? e.preventDefault() : (e.returnValue = !1), E(e), (a.style.transitionDuration = "0ms"), (r.style.transitionDuration = "0ms"), (n.style.transitionDuration = "0ms"), i("scrollbarDragMove", e));
        }
        function T(e) {
          const s = t.params.scrollbar,
            { scrollbar: a, wrapperEl: r } = t,
        ...
        function P() {
          ...
          t.params.uniqueNavElements && "string" == typeof a.el && i.length > 1 && 1 === s.querySelectorAll(a.el).length && (i = s.querySelector(a.el)),
            ...
            i && ((r = i.querySelector(ae(t.params.scrollbar.dragClass))), r || ((r = b("div", t.params.scrollbar.dragClass)), i.append(r))),
      ...
      function (e) {
        ...
        function x(e) {
          ...
          if (((n = !1), (o = !1), u.push(e), !(u.length < 2))) {
            if (((n = !0), (m.scaleStart = w()), !m.slideEl)) {
              ...
              if ((a && (a = a.querySelectorAll("picture, img, svg, canvas, .swiper-zoom-target")[0]), (m.imageEl = a), (m.imageWrapEl = a ? S(m.imageEl, `.${s.containerClass}`)[0] : void 0), !m.imageWrapEl))
        ...
        function L(e) {
          ...
          t.params.cssMode && ((t.wrapperEl.style.overflow = "hidden"), (t.wrapperEl.style.touchAction = "none")),
            ...
            void 0 === h.touchesStart.x && e ? ((i = e.pageX), (n = e.pageY)) : ((i = h.touchesStart.x), (n = h.touchesStart.y));
      ...
      function (e) {
        ...
        a("beforeInit", () => {
          (i = b("span", t.params.a11y.notificationClass)), i.setAttribute("aria-live", "assertive"), i.setAttribute("aria-atomic", "true");
        }),
          a("afterInit", () => {
              ...
              (function () {
                ...
                h() &&
                  t.pagination.bullets.forEach((s) => {
                    t.params.pagination.clickable && (n(s), t.params.pagination.renderBullet || (o(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, x(s) + 1)))),
          ...
          t.params.history.enabled &&
            (() => {
              ...
              if (t.params.history) {
                ...
                (i = !0),
                  (r = o(t.params.url)),
                  r.key || r.value ? (c(0, r.value, t.params.runCallbacksOnInit), t.params.history.replaceState || e.addEventListener("popstate", p)) : t.params.history.replaceState || e.addEventListener("popstate", p);
              }
            })();
        }),
          a("destroy", () => {
      ...
      function (e) {
        ...
        (a.autoplay = { running: !1, paused: !1, timeLeft: 0 }), i({ autoplay: { enabled: !1, delay: 3e3, waitForTransition: !0, disableOnInteraction: !1, stopOnLastSlide: !1, reverseDirection: !1, pauseOnMouseEnter: !1 } });
        let d,
          c,
          p,
          u,
        ...
        n("init", () => {
          ...
          n("destroy", () => {
            a.el.removeEventListener("pointerenter", L), a.el.removeEventListener("pointerleave", I), r().removeEventListener("visibilitychange", P), a.autoplay.running && T();
          }),
          ...
          Object.assign(t, {
            freeMode: {
              ...
              onTouchMove: function () {
                ...
                0 === e.velocities.length && e.velocities.push({ position: s[t.isHorizontal() ? "startX" : "startY"], time: e.touchStartTime }), e.velocities.push({ position: s[t.isHorizontal() ? "currentX" : "currentY"], time: c() });
              },
              onTouchEnd: function (e) {
                ...
                if (s < -t.minTranslate()) t.slideTo(t.activeIndex);
                  ...
                  if (r.freeMode.momentum) {
                    ...
                    let f;
                    if (p < t.maxTranslate())
                      r.freeMode.momentumBounce ? (p + t.maxTranslate() < -h && (p = t.maxTranslate() - h), (u = t.maxTranslate()), (m = !0), (d.allowMomentumBounce = !0)) : (p = t.maxTranslate()), r.loop && r.centeredSlides && (f = !0);
                    else if (p > t.minTranslate())
                      r.freeMode.momentumBounce ? (p - t.minTranslate() > h && (p = t.minTranslate() + h), (u = t.minTranslate()), (m = !0), (d.allowMomentumBounce = !0)) : (p = t.minTranslate()), r.loop && r.centeredSlides && (f = !0);
      ...
      function (e) {
        ...
        const i = (e, t, s) => {
          ...
          a || ((a = b("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "left" : "top")).split(" "))), e.append(a)),
            i || ((i = b("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (s ? "right" : "bottom")).split(" "))), e.append(i)),
        ...
        de({
          ...
          setTranslate: () => {
            ...
            c.shadow &&
              (p
                ? ((m = t.wrapperEl.querySelector(".swiper-cube-shadow")), m || ((m = b("div", "swiper-cube-shadow")), t.wrapperEl.append(m)), (m.style.height = `${r}px`))
                : ((m = e.querySelector(".swiper-cube-shadow")), m || ((m = b("div", "swiper-cube-shadow")), e.append(m))));
            for (let e = 0; e < a.length; e += 1) {
              const s = a[e];
              let r = e;
