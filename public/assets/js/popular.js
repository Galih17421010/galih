              ...
              t = (function () {
                ...
                return (
                  ...
                  (e.prototype.addField = function (e, t) {
                    ...
                    return (
                      (this.fields[e] = this.fields[e] ? { selector: n.selector || this.fields[e].selector, validators: Object.assign({}, this.fields[e].validators, n.validators) } : n),
              ...
              i = (function (e) {
                ...
                return (
                  ...
                  (i.prototype.prepareElementContainer = function (e, t, i) {
                    ...
                    r.appendChild(a),
                      n(a, { "fv-plugins-message-container": !0, "fv-plugins-message-container--enabled": this.isEnabled, "fv-plugins-message-container--disabled": !this.isEnabled }),
              ...
              o = (function (e) {
                function o(t) {
                  ...
                  return (
                    ...
                    (n.opts = Object.assign({}, { defaultMessageContainer: !0, eleInvalidClass: "", eleValidClass: "", rowClasses: "", rowValidatingClass: "" }, t)),
                    (n.elementIgnoredHandler = n.onElementIgnored.bind(n)),
                    (n.elementValidatingHandler = n.onElementValidating.bind(n)),
                    (n.elementValidatedHandler = n.onElementValidated.bind(n)),
                    (n.elementNotValidatedHandler = n.onElementNotValidated.bind(n)),
            ...
            var e = a,
              ...
              i = (function (e) {
                function i(t) {
                  ...
                  return (
                    (n.icons = new Map()),
                    (n.opts = Object.assign({}, { invalid: "fv-plugins-icon--invalid", onPlaced: function () {}, onSet: function () {}, valid: "fv-plugins-icon--valid", validating: "fv-plugins-icon--validating" }, t)),
                    (n.elementValidatingHandler = n.onElementValidating.bind(n)),
                    (n.elementValidatedHandler = n.onElementValidated.bind(n)),
                    (n.elementNotValidatedHandler = n.onElementNotValidated.bind(n)),
                    (n.elementIgnoredHandler = n.onElementIgnored.bind(n)),
                ...
                return (
                  ...
                  (i.prototype.install = function () {
                    ...
                    (this.tip = document.createElement("div")),
                      n(this.tip, (((e = { "fv-plugins-tooltip": !0 })["fv-plugins-tooltip--".concat(this.opts.placement)] = !0), e)),
                ...
                return {
                  validate: function (i) {
                    ...
                    var o = Object.assign({}, { inclusive: !0, message: "" }, n(i.options)),
                      ...
                      s = e(o.max);
                    return o.inclusive
                      ? { message: t(i.l10n ? o.message || i.l10n.between.default : o.message, ["".concat(a), "".concat(s)]), valid: parseFloat(r) >= a && parseFloat(r) <= s }
                      : { message: t(i.l10n ? o.message || i.l10n.between.notInclusive : o.message, ["".concat(a), "".concat(s)]), valid: parseFloat(r) > a && parseFloat(r) < s };
                  },
                };
              }),
              ce
                ...
                return {
                  validate: function (t) {
                    ...
                    if (window.File && window.FileList && window.FileReader) {
                      ...
                      for (var d = {}, c = 0; c < s; c++) {
                        if (
                          ((l += a[c].size), (d = { ext: (n = a[c].name.substr(a[c].name.lastIndexOf(".") + 1)), file: a[c], size: a[c].size, type: a[c].type }), t.options.minSize && a[c].size < parseInt("".concat(t.options.minSize), 10))
                        )
              ...
              (Je.greaterThan = function () {
                return {
                  validate: function (e) {
                    ...
                    return i.inclusive
                      ? { message: t(e.l10n ? i.message || e.l10n.greaterThan.default : i.message, "".concat(r)), valid: parseFloat(e.value) >= r }
                      : { message: t(e.l10n ? i.message || e.l10n.greaterThan.notInclusive : i.message, "".concat(r)), valid: parseFloat(e.value) > r };
                  },
                };
              }),
              Je
              ...
              (ft.lessThan = function () {
                return {
                  validate: function (e) {
                    ...
                    return i.inclusive
                      ? { message: t(e.l10n ? i.message || e.l10n.lessThan.default : i.message, "".concat(r)), valid: parseFloat(e.value) <= r }
                      : { message: t(e.l10n ? i.message || e.l10n.lessThan.notInclusive : i.message, "".concat(r)), valid: parseFloat(e.value) < r };
                  },
                };
              }),
              ft
