              ...
              return (
                ...
                (e.prototype.executeValidator = function (e, t, i, n) {
                  ...
                  if (((n.message = this.filter.execute("validator-message", n.message, [this.locale, e, s])), !this.validators[s] || !1 === n.enabled))
                    return this.emit("core.validator.validated", { element: t, elements: o, field: e, result: this.normalizeResult(e, s, { valid: !0 }), validator: s }), Promise.resolve("Valid");
                  var l = this.validators[s],
                    a = this.getElementValue(e, t, s);
                  if (!this.filter.execute("field-should-validate", !0, [e, t, a, i])) return this.emit("core.validator.notvalidated", { element: t, elements: o, field: e, validator: i }), Promise.resolve("NotValidated");
                  this.emit("core.validator.validating", { element: t, elements: o, field: e, validator: i });
                  var d = l().validate({ element: t, elements: o, field: e, l10n: this.localization, options: n, value: a });
                  if ("function" == typeof d.then)
                    return d.then(function (n) {
                      var s = r.normalizeResult(e, i, n);
                      return r.emit("core.validator.validated", { element: t, elements: o, field: e, result: s, validator: i }), s.valid ? "Valid" : "Invalid";
                    });
                  var u = this.normalizeResult(e, i, d);
                  return this.emit("core.validator.validated", { element: t, elements: o, field: e, result: u, validator: i }), Promise.resolve(u.valid ? "Valid" : "Invalid");
                }),
                ...
                (e.prototype.updateElementStatus = function (e, t, i, n) {
                  ...
                  switch (i) {
                    ...
                    case "Valid":
                      l.forEach(function (i) {
                        return r.emit("core.validator.validated", { element: t, elements: o, field: e, result: { message: s[i].message, valid: !0 }, validator: i });
                      }),
                        this.emit("core.element.validated", { element: t, elements: o, field: e, valid: !0 });
                      break;
                    case "Invalid":
                      l.forEach(function (i) {
                        return r.emit("core.validator.validated", { element: t, elements: o, field: e, result: { message: s[i].message, valid: !1 }, validator: i });
                      }),
          ...
          var n = i(4786),
            ...
            s = (function (e) {
              function t(t) {
                ...
                return (i.opts = Object.assign({}, { onPrefocus: function () {} }, t)), (i.invalidFormHandler = i.onFormInvalid.bind(i)), i;
              }
              return (
                (function (e, t) {
