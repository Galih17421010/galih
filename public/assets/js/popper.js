        ...
        6063: function (e, t) {
          !(function (e) {
            ...
            function y(e, n, o) {
              ...
              return (
                (f || (!f && !o)) &&
                  (("body" !== l(n) || v(h)) && (g = (i = n) !== t(i) && r(i) ? { scrollLeft: (a = i).scrollLeft, scrollTop: a.scrollTop } : u(i)), r(n) ? (((b = p(n, !0)).x += n.clientLeft), (b.y += n.clientTop)) : h && (b.x = m(h))),
                ...
                : _(
                    (function (e) {
                      var t,
                        ...
                        f = -r.scrollLeft + m(e),
                        c = -r.scrollTop;
                      return "rtl" === h(o || n).direction && (f += i(n.clientWidth, o ? o.clientWidth : 0) - a), { width: a, height: s, x: f, y: c };
                    })(d(e))
                  );
            }
            function I(e, t, o, s) {
            ...
            function J(e, t) {
              ...
              var r = t,
                ...
                S = h === H ? W : M,
                T = { top: E.top - S.top + x.top, bottom: S.bottom - E.bottom + x.bottom, left: E.left - S.left + x.left, right: S.right - E.right + x.right },
            ...
            function re(e) {
              ...
              if (u) {
                var W = E(r),
                  B = "clientHeight",
                  H = "clientWidth";
                W === t(r) && "static" !== h((W = d(r))).position && "absolute" === c && ((B = "scrollHeight"), (H = "scrollWidth")),
                  (i === D || ((i === M || i === P) && a === S)) && ((L = A), (b -= (m && W === k && k.visualViewport ? k.visualViewport.height : W[B]) - o.height), (b *= p ? 1 : -1)),
                  (i !== M && ((i !== D && i !== A) || a !== S)) || ((j = P), (y -= (m && W === k && k.visualViewport ? k.visualViewport.width : W[H]) - o.width), (y *= p ? 1 : -1));
              }
              var T,
              ...
              return (
                ...
                (b = V.y),
                p
                  ? Object.assign({}, R, (((T = {})[L] = O ? "0" : ""), (T[j] = w ? "0" : ""), (T.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + y + "px, " + b + "px)" : "translate3d(" + y + "px, " + b + "px, 0)"), T))
                  : Object.assign({}, R, (((n = {})[L] = O ? b + "px" : ""), (n[j] = w ? y + "px" : ""), (n.transform = ""), n))
              );
            }
            var oe = {
                name: "computeStyles",
                      ...
                      return (
                        (e[n] = (function (e, t, n) {
                          var r = F(e),
                            ...
                            a = i[0],
                            s = i[1];
                          return (a = a || 0), (s = (s || 0) * o), [M, P].indexOf(r) >= 0 ? { x: s, y: a } : { x: a, y: s };
                        })(n, t.rects, i)),
                        e
                      );
                    }, {}),
                  ...
                  for (
                    var o = n.mainAxis,
                      ...
                      b = [v].concat(g).reduce(function (e, n) {
                        return e.concat(F(n) === L ? ue(t, { placement: n, boundary: p, rootBoundary: u, padding: c, flipVariations: m, allowedAutoPlacements: h }) : n);
                      }, []),
                      x = t.rects.reference,
                      w = t.rects.popper,
                      O = new Map(),
