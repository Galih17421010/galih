      ...
      (function (qn) {
        (function (j, Je) {
          ...
          function Ft(e, t, n) {
            ...
            if (((u.text = e), t)) for (r in Hn) (o = t[r] || (t.getAttribute && t.getAttribute(r))), o && u.setAttribute(r, o);
                      ...
                      (r = e[t]),
                        !(t === "__proto__" || a === r) &&
                          (d && r && (i.isPlainObject(r) || (o = Array.isArray(r)))
                            ? ((n = a[t]), o && !Array.isArray(n) ? (u = []) : !o && !i.isPlainObject(n) ? (u = {}) : (u = n), (o = !1), (a[t] = i.extend(d, u, r)))
                            : r !== void 0 && (a[t] = r));
                return a;
              }),
            i.extend({
              ...
              each: function (e, t) {
                var n,
                  r = 0;
                if (lt(e)) for (n = e.length; r < n && t.call(e[r], r, e[r]) !== !1; r++);
              ...
              makeArray: function (e, t) {
                var n = t || [];
                return e != null && (lt(Object(e)) ? i.merge(n, typeof e == "string" ? [e] : e) : Ke.call(n, e)), n;
              },
              ...
              map: function (e, t, n) {
                var r,
                  ...
                  u = 0,
                  a = [];
                if (lt(e)) for (r = e.length; u < r; u++) (o = t(e[u], u, n)), o != null && a.push(o);
          ...
          (function () {
              ...
              return (
                p == a ||
                      ...
                      (t.find.ID = function (g, v) {
                        if (typeof v.getElementById < "u" && f) {
                          ...
                          if (C) {
                            ...
                            for (w = v.getElementsByName(g), T = 0; (C = w[T++]); ) if (((m = C.getAttributeNode("id")), m && m.value === g)) return [C];
                          }
                          return [];
                        }
                      })),
                  ...
                  (z = function (g, v) {
                    ...
                    return (
                      m ||
                      ((m = (g.ownerDocument || g) == (v.ownerDocument || v) ? g.compareDocumentPosition(v) : 1),
              ...
              (t = i.expr =
                {
                  ...
                  preFilter: {
                    ...
                    CHILD: function (s) {
                      return (
                        (s[1] = s[1].toLowerCase()),
                        s[1].slice(0, 3) === "nth" ? (s[3] || _.error(s[0]), (s[4] = +(s[4] ? s[5] + (s[6] || 1) : 2 * (s[3] === "even" || s[3] === "odd"))), (s[5] = +(s[7] + s[8] || s[3] === "odd"))) : s[3] && _.error(s[0]),
                        s
                      );
                    },
                    PSEUDO: function (s) {
                      ...
                      return ce.CHILD.test(s[0])
                        ? null
                        : (s[3] ? (s[2] = s[4] || s[5] || "") : p && fe.test(p) && (l = Ye(p, !0)) && (l = p.indexOf(")", p.length - l) - p.length) && ((s[0] = s[0].slice(0, l)), (s[2] = p.slice(0, l))), s.slice(0, 3));
                    },
                  },
                  filter: {
                    TAG: function (s) {
                      ...
                      return g === 1 && v === 0
                        ...
                        : function (C, O, A) {
                            ...
                            if (ne) {
                              if (m) {
                                for (; X; ) {
                                  for (E = C; (E = E[X]); ) if (w ? $(E, le) : E.nodeType === 1) return !1;
                    ...
                    PSEUDO: function (s, l) {
                      var p,
                        g = t.pseudos[s] || t.setFilters[s.toLowerCase()] || _.error("unsupported pseudo: " + s);
                      return g[b]
                        ? g(l)
                        : g.length > 1
                        ? ((p = [s, s, "", l]),
                  ...
                  pseudos: {
                    ...
                    lang: ie(function (s) {
                      return (
                        ...
                        function (l) {
                          var p;
                          do if ((p = f ? l.lang : l.getAttribute("xml:lang") || l.getAttribute("lang"))) return (p = p.toLowerCase()), p === s || p.indexOf(s + "-") === 0;
                    ...
                    empty: function (s) {
                      for (s = s.firstChild; s; s = s.nextSibling) if (s.nodeType < 6) return !1;
                      return !0;
                    },
                    parent: function (s) {
            ...
            for (e in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 }) t.pseudos[e] = Rr(e);
            ...
            function Ye(s, l) {
              ...
              for (T = s, w = [], C = t.preFilter; T; ) {
                (!p || (g = B.exec(T))) && (g && (T = T.slice(g[0].length) || T), w.push((v = []))), (p = !1), (g = Ge.exec(T)) && ((p = g.shift()), v.push({ value: p, type: g[0].replace(_e, " ") }), (T = T.slice(p.length)));
                for (m in t.filter) (g = ce[m].exec(T)) && (!C[m] || (g = C[m](g))) && ((p = g.shift()), v.push({ value: p, type: m, matches: g }), (T = T.slice(p.length)));
                if (!p) break;
              }
              ...
              return l.first
                ...
                : function (C, O, A) {
                    var N,
                      ...
                      E = [h, w];
                    if (A) {
                      for (; (C = C[g]); ) if ((C.nodeType === 1 || T) && s(C, O, A)) return !0;
                    } else
                      for (; (C = C[g]); )
                        if (C.nodeType === 1 || T)
            ...
            function Ht(s, l, p, g, v, m) {
              return (
                ...
                ie(function (T, w, C, O) {
                  ...
                  if ((p ? ((E = v || (T ? s : X || g) ? [] : w), p(le, E, C, O)) : (E = le), g)) for (A = ct(E, K), g(A, [], C, O), N = A.length; N--; ) (P = A[N]) && (E[K[N]] = !(le[K[N]] = P));
                  if (T) {
                    if (v || s) {
                      if (v) {
              ...
              for (
                ...
                if ((p = t.relative[s[w].type])) A = [ft(Lt(A), p)];
                  ...
                  if (((p = t.filter[s[w].type].apply(null, s[w].matches)), p[b])) {
                    ...
                    return Ht(w > 1 && Lt(A), w > 1 && st(s.slice(0, w - 1).concat({ value: s[w - 2].type === " " ? "*" : "" })).replace(_e, "$1"), p, w < g && Ot(s.slice(w, g)), g < v && Ot((s = s.slice(g))), g < v && st(s));
                  }
                  A.push(p);
                }
              return Lt(A);
            ...
            function Pt(s, l) {
              var p,
                ...
                m = H[s + " "];
              if (!m) {
                for (l || (l = Ye(s)), p = l.length; p--; ) (m = Ot(l[p])), m[b] ? g.push(m) : v.push(m);
            ...
            function kn(s, l, p, g) {
              ...
              return (O || Pt(s, A))(g, l, !f, p, !l || (jt.test(s) && qt(l.parentNode)) || l), p;
            }
            ...
            Fn = (i.fn.init = function (e, t, n) {
              ...
              if (((n = n || Vt), typeof e == "string"))
                if ((e[0] === "<" && e[e.length - 1] === ">" && e.length >= 3 ? (r = [null, e, null]) : (r = Wn.exec(e)), r && (r[1] || !t)))
                  if (r[1]) {
                    if (((t = t instanceof i ? t[0] : t), i.merge(this, i.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : k, !0)), Ut.test(r[1]) && i.isPlainObject(t))) for (r in t) L(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                    return this;
                  } else return (o = k.getElementById(r[2])), o && ((this[0] = o), (this.length = 1)), this;
          ...
          i.Callbacks = function (e) {
            ...
            var t,
              ...
              c = -1,
              f = function () {
                for (o = o || e.once, r = t = !0; a.length; c = -1) for (n = a.shift(); ++c < u.length; ) u[c].apply(n[0], n[1]) === !1 && e.stopOnFalse && ((c = u.length), (n = !1));
                ...
                remove: function () {
                  return (
                    i.each(arguments, function (y, b) {
                      for (var h; (h = i.inArray(b, u, h)) > -1; ) u.splice(h, 1), h <= c && c--;
                    }),
                    this
                  );
                },
                          ...
                          H = function () {
                            ...
                            if (!(y < f)) {
                              ...
                              (ae = z && (typeof z == "object" || typeof z == "function") && z.then),
                                L(ae) ? (x ? ae.call(z, d(f, b, ke, x), d(f, b, et, x)) : (f++, ae.call(z, d(f, b, ke, x), d(f, b, et, x), d(f, b, ke, b.notifyWith)))) : (h !== ke && ((D = void 0), (R = [z])), (x || b.resolveWith)(D, R));
                            }
                          },
                          V = x
                            ? H
            ...
            (Fe.prototype = {
              ...
              remove: function (e, t) {
                var n,
                  r = e[this.expando];
                if (r !== void 0) {
                  if (t !== void 0) for (Array.isArray(t) ? (t = t.map(ue)) : ((t = ue(t)), (t = (t in r) ? [t] : t.match(oe) || [])), n = t.length; n--; ) delete r[t[n]];
          ...
          function Jt(e, t, n, r) {
            var o,
              ...
              y = e.nodeType && (i.cssNumber[t] || (d !== "px" && +f)) && $e.exec(i.css(e, t));
            if (y && y[3] !== d) {
              for (f = f / 2, d = d || y[3], y = +f || 1; a--; ) i.style(e, t, y + d), (1 - u) * (1 - (u = c() / f || 0.5)) <= 0 && (a = 0), (y = y / u);
          ...
          function qe(e, t) {
            for (var n, r, o = [], u = 0, a = e.length; u < a; u++)
              (r = e[u]),
                r.style &&
                  ((n = r.style.display),
                  t ? (n === "none" && ((o[u] = S.get(r, "display") || null), o[u] || (r.style.display = "")), r.style.display === "" && nt(r) && (o[u] = Zn(r))) : n !== "none" && ((o[u] = "none"), S.set(r, "display", n)));
          ...
          function tn(e, t, n, r, o) {
            ...
            for (b.textContent = "", x = 0; (u = h[x++]); ) {
              ...
              if (((d = je(u)), (a = Y(b.appendChild(u), "script")), d && gt(a), n)) for (y = 0; (u = a[y++]); ) en.test(u.type || "") && n.push(u);
            }
            return b;
          }
          var nn = /^([^.]*)(?:\.(.+)|)/;
                ...
                for (
                  ...
                  (c = nn.exec(t[d]) || []),
                    ...
                    x &&
                      ...
                      (b = i.event.special[x] || {}),
                      (y = i.extend({ type: x, origType: R, data: r, handler: n, guid: n.guid, selector: o, needsContext: o && i.expr.match.needsContext.test(o), namespace: D.join(".") }, u)),
                      (h = f[x]) || ((h = f[x] = []), (h.delegateCount = 0), (!b.setup || b.setup.call(e, r, D, a) === !1) && e.addEventListener && e.addEventListener(x, a)),
                      b.add && (b.add.call(e, y), y.handler.guid || (y.handler.guid = n.guid)),
                  ...
                  for (b = i.event.special[x] || {}, x = (r ? b.delegateType : b.bindType) || x, h = f[x] || [], c = c[2] && new RegExp("(^|\\.)" + D.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = u = h.length; u--; )
                    (y = h[u]),
                      (o || R === y.origType) &&
                        ...
                        (h.splice(u, 1), y.selector && h.delegateCount--, b.remove && b.remove.call(e, y));
              ...
              if (((f.delegateTarget = this), !(y.preDispatch && y.preDispatch.call(this, f) === !1))) {
                for (a = i.event.handlers.call(this, f, d), t = 0; (o = a[t++]) && !f.isPropagationStopped(); )
                  for (f.currentTarget = o.elem, n = 0; (u = o.handlers[n++]) && !f.isImmediatePropagationStopped(); )
                    (!f.rnamespace || u.namespace === !1 || f.rnamespace.test(u.namespace)) &&
                      ((f.handleObj = u), (f.data = u.data), (r = ((i.event.special[u.origType] || {}).handle || u.handler).apply(o.elem, c)), r !== void 0 && (f.result = r) === !1 && (f.preventDefault(), f.stopPropagation()));
          ...
          (i.removeEvent = function (e, t, n) {
            ...
            i.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
              ...
              (i.event.special[e] = {
                setup: function () {
                  var r;
                  if ((rt(this, e, !0), k.documentMode)) (r = S.get(this, t)), r || this.addEventListener(t, n), S.set(this, t, (r || 0) + 1);
                  else return !1;
                },
                trigger: function () {
                  return rt(this, e), !0;
                ...
                teardown: function () {
                  var r;
                  if (k.documentMode) (r = S.get(this, t) - 1), r ? S.set(this, t, r) : (this.removeEventListener(t, n), S.remove(this, t));
                  else return !1;
                },
                _default: function (r) {
          ...
          function on(e, t) {
            ...
            if (t.nodeType === 1) {
              if (S.hasData(e) && ((u = S.get(e)), (f = u.events), f)) {
                ...
                for (o in f) for (n = 0, r = f[o].length; n < r; n++) i.event.add(t, o, f[o][n]);
              }
          ...
          function Oe(e, t, n, r) {
            ...
            if (b && ((o = tn(t, e[0].ownerDocument, !1, e, r)), (u = o.firstChild), o.childNodes.length === 1 && (o = u), u || r)) {
              for (a = i.map(Y(o, "script"), ir), c = a.length; y < b; y++) (f = o), y !== h && ((f = i.clone(f, !0, !0)), c && i.merge(a, Y(f, "script"))), n.call(e[y], f, y);
              if (c)
                for (d = a[a.length - 1].ownerDocument, i.map(a, or), y = 0; y < c; y++)
                  (f = a[y]),
                    en.test(f.type || "") &&
                      ...
                      i.contains(d, f) &&
                      (f.src && (f.type || "").toLowerCase() !== "module" ? i._evalUrl && !f.noModule && i._evalUrl(f.src, { nonce: f.nonce || f.getAttribute("nonce") }, d) : Ft(f.textContent.replace(rr, ""), f, d));
            }
            return e;
          }
          function un(e, t, n) {
            for (var r, o = t ? i.filter(t, e) : e, u = 0; (r = o[u]) != null; u++) !n && r.nodeType === 1 && i.cleanData(Y(r)), r.parentNode && (n && je(r) && gt(Y(r, "script")), r.parentNode.removeChild(r));
            return e;
          }
          i.extend({
            ...
            clone: function (e, t, n) {
              var r,
                ...
                c = e.cloneNode(!0),
                f = je(e);
              if (!q.noCloneChecked && (e.nodeType === 1 || e.nodeType === 11) && !i.isXMLDoc(e)) for (a = Y(c), u = Y(e), r = 0, o = u.length; r < o; r++) ur(u[r], a[r]);
              if (t)
                if (n) for (u = u || Y(e), a = a || Y(c), r = 0, o = u.length; r < o; r++) on(u[r], a[r]);
                else on(e, c);
            ...
            cleanData: function (e) {
              for (var t, n, r, o = i.event.special, u = 0; (n = e[u]) !== void 0; u++)
                if (We(n)) {
                  if ((t = n[S.expando])) {
                    if (t.events) for (r in t.events) o[r] ? i.event.remove(n, r) : i.removeEvent(n, r, t.handle);
                    n[S.expando] = void 0;
                  }
            ...
            i.fn.extend({
              ...
              empty: function () {
                for (var e, t = 0; (e = this[t]) != null; t++) e.nodeType === 1 && (i.cleanData(Y(e, !1)), (e.textContent = ""));
                return this;
              },
              clone: function (e, t) {
                return (
          ...
          function ze(e, t, n) {
            ...
            return (
              ...
              n &&
                ...
                !q.pixelBoxStyles() && vt.test(a) && ar.test(t) && ((r = f.width), (o = f.minWidth), (u = f.maxWidth), (f.minWidth = f.maxWidth = f.width = a), (a = n.width), (f.width = r), (f.minWidth = o), (f.maxWidth = u))),
              a !== void 0 ? a + "" : a
            );
          }
          function sn(e, t) {
          ...
          var fn = ["Webkit", "Moz", "ms"],
            ...
            ln = {};
          function sr(e) {
            for (var t = e[0].toUpperCase() + e.slice(1), n = fn.length; n--; ) if (((e = fn[n] + t), e in cn)) return e;
          }
          function xt(e) {
          ...
          function mt(e, t, n, r, o, u) {
            ...
            for (; a < 4; a += 2)
              n === "margin" && (d += i.css(e, n + ge[a], !0, o)),
                r
                  ? (n === "content" && (f -= i.css(e, "padding" + ge[a], !0, o)), n !== "margin" && (f -= i.css(e, "border" + ge[a] + "Width", !0, o)))
                  : ((f += i.css(e, "padding" + ge[a], !0, o)), n !== "padding" ? (f += i.css(e, "border" + ge[a] + "Width", !0, o)) : (c += i.css(e, "border" + ge[a] + "Width", !0, o)));
            return !r && u >= 0 && (f += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - u - f - c - 0.5)) || 0), f + d;
          }
          function hn(e, t, n) {
            var r = it(e),
            ...
            return (
              ((!q.boxSizingReliable() && u) || (!q.reliableTrDimensions() && $(e, "tr")) || c === "auto" || (!parseFloat(c) && i.css(e, "display", !1, r) === "inline")) &&
                e.getClientRects().length &&
                ((u = i.css(e, "boxSizing", !1, r) === "border-box"), (a = f in e), a && (c = e[f])),
              (c = parseFloat(c) || 0),
          ...
          i.extend({
            ...
            style: function (e, t, n, r) {
              if (!(!e || e.nodeType === 3 || e.nodeType === 8 || !e.style)) {
                ...
                if ((f || (t = xt(c)), (a = i.cssHooks[t] || i.cssHooks[c]), n !== void 0)) {
                  if (((u = typeof n), u === "string" && (o = $e.exec(n)) && o[1] && ((n = Jt(e, t, o)), (u = "number")), n == null || n !== n)) return;
            ...
            css: function (e, t, n, r) {
              ...
              return (
                ...
                n === "" || n ? ((u = parseFloat(o)), n === !0 || isFinite(u) ? u || 0 : o) : o
              );
            },
          }),
            i.each(["height", "width"], function (e, t) {
              i.cssHooks[t] = {
                get: function (n, r, o) {
                  if (r)
                    return fr.test(i.css(n, "display")) && (!n.getClientRects().length || !n.getBoundingClientRect().width)
                      ? an(n, cr, function () {
                          return hn(n, t, o);
                        })
                      : hn(n, t, o);
                ...
                set: function (n, r, o) {
                  var u,
                    ...
                    y = o ? mt(n, t, o, d, a) : 0;
                  return (
                    d && c && (y -= Math.ceil(n["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(a[t]) - mt(n, t, "border", !1, a) - 0.5)),
                    y && (u = $e.exec(r)) && (u[3] || "px") !== "px" && ((n.style[t] = r), (r = i.css(n, t))),
                    pn(n, r, y)
                  );
                },
              };
          ...
          (i.Tween = J),
            (J.prototype = {
              ...
              run: function (e) {
                ...
                return (
                  this.options.duration ? (this.pos = t = i.easing[this.easing](e, this.options.duration * e, 0, 1, this.options.duration)) : (this.pos = t = e),
          ...
          function yn(e, t, n) {
            for (var r, o = (re.tweeners[t] || []).concat(re.tweeners["*"]), u = 0, a = o.length; u < a; u++) if ((r = o[u].call(n, t, e))) return r;
          }
          function pr(e, t, n) {
            var r,
              o,
            ...
            if (((f = !i.isEmptyObject(t)), !(!f && i.isEmptyObject(x)))) {
              b &&
                ...
                (y = i.css(e, "display")),
                y === "none" && (d ? (y = d) : (qe([e], !0), (d = e.style.display || d), (y = i.css(e, "display")), qe([e]))),
              ...
              for (r in x)
                f ||
                  (H ? "hidden" in H && (R = H.hidden) : (H = S.access(e, "fxshow", { display: d })),
                  u && (H.hidden = !R),
                  R && qe([e], !0),
                  h.done(function () {
          ...
          function re(e, t, n) {
            var r,
              ...
              y = d.props;
            for (hr(y, d.opts.specialEasing); u < a; u++) if (((r = re.prefilters[u].call(d, e, y, d.opts)), r)) return L(r.stop) && (i._queueHooks(d.elem, d.opts.queue).stop = r.stop.bind(r)), r;
            return (
              i.map(y, yn, d),
          ...
          (i.Animation = i.extend(re, {
            ...
            (i.speed = function (e, t, n) {
              var r = e && typeof e == "object" ? i.extend({}, e) : { complete: n || (!n && t) || (L(e) && e), duration: e, easing: (n && t) || (t && !L(t) && t) };
              return (
                i.fx.off ? (r.duration = 0) : typeof r.duration != "number" && (r.duration in i.fx.speeds ? (r.duration = i.fx.speeds[r.duration]) : (r.duration = i.fx.speeds._default)),
            ...
            i.each({ slideDown: ut("show"), slideUp: ut("hide"), slideToggle: ut("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
          ...
          i.fn.extend({
            ...
            i.extend({
              prop: function (e, t, n) {
                ...
                if (!(u === 3 || u === 8 || u === 2))
                  return (
                    (u !== 1 || !i.isXMLDoc(e)) && ((t = i.propFix[t] || t), (o = i.propHooks[t])),
          ...
          i.fn.extend({
              ...
              return L(e)
                ...
                ? ((t = Ct(e)),
                  t.length
                    ? this.each(function () {
                        if (((r = we(this)), (n = this.nodeType === 1 && " " + Ce(r) + " "), n)) {
                          for (u = 0; u < t.length; u++) for (o = t[u]; n.indexOf(" " + o + " ") > -1; ) n = n.replace(" " + o + " ", " ");
                          (a = Ce(n)), r !== a && this.setAttribute("class", a);
                        }
                      })
                    : this)
            ...
            toggleClass: function (e, t) {
              ...
              return L(e)
                ...
                : ((n = Ct(e)),
                  this.each(function () {
                    if (c) for (u = i(this), o = 0; o < n.length; o++) (r = n[o]), u.hasClass(r) ? u.removeClass(r) : u.addClass(r);
            ...
            hasClass: function (e) {
              var t,
                n,
                r = 0;
              for (t = " " + e + " "; (n = this[r++]); ) if (n.nodeType === 1 && (" " + Ce(we(n)) + " ").indexOf(t) > -1) return !0;
              return !1;
            },
          });
          var vr = /\r/g;
          i.fn.extend({
            val: function (e) {
              ...
              return arguments.length
                ...
                : o
                ? ((t = i.valHooks[o.type] || i.valHooks[o.nodeName.toLowerCase()]), t && "get" in t && (n = t.get(o, "value")) !== void 0 ? n : ((n = o.value), typeof n == "string" ? n.replace(vr, "") : n ?? ""))
                : void 0;
            },
          }),
            i.extend({
...
`)
              ...
              if (
                ...
                for (o = 0; (u = h[o++]) && !e.isPropagationStopped(); )
                  (b = u),
                    ...
                    d && d.apply(u, t),
                    (d = f && u[f]),
                    d && d.apply && We(u) && ((e.result = d.apply(u, t)), e.result === !1 && e.preventDefault());
                return (
                  (e.type = x),
                  !r &&
          ...
          function St(e, t, n, r) {
            ...
            else if (!n && De(t) === "object") for (o in t) St(e + "[" + o + "]", t[o], n, r);
            else r(e, t);
          }
...
`
          ...
          function Sn(e) {
            return function (t, n) {
              ...
              if (L(n)) for (; (r = u[o++]); ) r[0] === "+" ? ((r = r.slice(1) || "*"), (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n);
            };
          }
          function En(e, t, n, r) {
            var o = {},
                  ...
                  if (a !== !0)
                    if (a && e.throws) t = a(t);
                      ...
                      try {
                        ...
                        return { state: "parsererror", error: a ? b : "No conversion from " + f + " to " + u };
                      }
                }
              }
          ...
          i.extend({
            ...
            ajax: function (e, t) {
              ...
              var n,
                ...
                M = {
                  ...
                  getResponseHeader: function (I) {
                    var B;
                    if (f) {
                      if (!u) for (u = {}; (B = Sr.exec(o)); ) u[B[1].toLowerCase() + " "] = (u[B[1].toLowerCase() + " "] || []).concat(B[2]);
                      B = u[I.toLowerCase() + " "];
                    }
              ...
              (d = i.event && h.global),
                ...
                (r = h.url.replace(Cr, "")),
                h.hasContent
                  ? h.data && h.processData && (h.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && (h.data = h.data.replace(Tr, "+"))
                  : ((b = h.url.slice(r.length)),
                    h.data && (h.processData || typeof h.data == "string") && ((r += (wt.test(r) ? "&" : "?") + h.data), delete h.data),
                    h.cache === !1 && ((r = r.replace(wr, "$1")), (b = (wt.test(r) ? "&" : "?") + "_=" + bn.guid++ + b)),
                    (h.url = r + b)),
                h.ifModified && (i.lastModified[r] && M.setRequestHeader("If-Modified-Since", i.lastModified[r]), i.etag[r] && M.setRequestHeader("If-None-Match", i.etag[r])),
              ...
              if (((se = "abort"), H.add(h.complete), M.done(h.success), M.fail(h.error), (n = En(Et, h, t, M)), !n)) Se(-1, "No Transport");
              else {
              ...
              function Se(I, B, Ge, kt) {
                ...
                f ||
                  ...
                  (be = kr(h, be, M, fe)),
                  fe
                    ? (h.ifModified && ((xe = M.getResponseHeader("Last-Modified")), xe && (i.lastModified[r] = xe), (xe = M.getResponseHeader("etag")), xe && (i.etag[r] = xe)),
                      I === 204 || h.type === "HEAD" ? (te = "nocontent") : I === 304 ? (te = "notmodified") : ((te = be.state), (Qe = be.data), (ce = be.error), (fe = !ce)))
                  ...
                  H.fireWith(x, [M, te]),
                  d && (D.trigger("ajaxComplete", [M, h]), --i.active || i.event.trigger("ajaxStop")));
              }
              return M;
            },
            ...
            i.each(["get", "post"], function (e, t) {
              i[t] = function (n, r, o, u) {
                return L(r) && ((u = u || o), (o = r), (r = void 0)), i.ajax(i.extend({ url: n, type: t, dataType: u, data: r, success: o }, i.isPlainObject(n) && n));
              };
            }),
                      ...
                      return function () {
                        t &&
                          ...
                          c === "abort"
                            ...
                            : o(jr[a.status] || a.status, a.statusText, (a.responseType || "text") !== "text" || typeof a.responseText != "string" ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
                      };
                    }),
                      (a.onload = t()),
          ...
          i.ajaxSetup({
            ...
            i.ajaxPrefilter("json jsonp", function (e, t, n) {
              var r,
                o,
                u,
                a = e.jsonp !== !1 && (Nt.test(e.url) ? "url" : typeof e.data == "string" && (e.contentType || "").indexOf("application/x-www-form-urlencoded") === 0 && Nt.test(e.data) && "data");
              if (a || e.dataTypes[0] === "jsonp")
                return (
                  (r = e.jsonpCallback = L(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
            ...
            (i.parseHTML = function (e, t, n) {
              ...
              var r, o, u;
              return (
                t || (q.createHTMLDocument ? ((t = k.implementation.createHTMLDocument("")), (r = t.createElement("base")), (r.href = k.location.href), t.head.appendChild(r)) : (t = k)),
                (o = Ut.exec(e)),
                (u = !n && []),
                o ? [t.createElement(o[1])] : ((o = tn([e], t, u)), u && u.length && i(u).remove(), i.merge([], o.childNodes))
              );
            }),
            (i.fn.load = function (e, t, n) {
              ...
              return (
                ...
                L(t) ? ((n = t), (t = void 0)) : t && typeof t == "object" && (o = "POST"),
                a.length > 0 &&
                  i
            ...
            (i.offset = {
              setOffset: function (e, t, n) {
                ...
                y === "static" && (e.style.position = "relative"),
                  ...
                  d ? ((r = b.position()), (a = r.top), (o = r.left)) : ((a = parseFloat(u) || 0), (o = parseFloat(f) || 0)),
            ...
            i.fn.extend({
              ...
              position: function () {
                if (this[0]) {
                  ...
                  return { top: t.top - o.top - i.css(r, "marginTop", !0), left: t.left - o.left - i.css(r, "marginLeft", !0) };
                }
              },
            ...
            i.each(["top", "left"], function (e, t) {
              i.cssHooks[t] = sn(q.pixelPosition, function (n, r) {
                if (r) return (r = ze(n, t)), vt.test(r) ? i(n).position()[t] + "px" : r;
              });
            }),
                  ...
                  return he(
                    ...
                    function (f, d, y) {
                      ...
                      return Ae(f)
                        ...
                        : f.nodeType === 9
                        ? ((b = f.documentElement), Math.max(f.body["scroll" + e], b["scroll" + e], f.body["offset" + e], b["offset" + e], b["client" + e]))
                        : y === void 0
                        ? i.css(f, d, c)
                        : i.style(f, d, y, c);
                    },
